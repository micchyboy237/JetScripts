import json
from jet.validation import schema_validate_json
...
def main_invalid_json():
    ...
    result = schema_validate_json(invalid_json_sample, resume_schema)
...
def main_valid_json_incorrect():
    ...
    result = schema_validate_json(valid_json_incorrect_sample, resume_schema)
    logger.success(json.dumps(make_serializable(result), indent=2))
...
def main_valid_json_correct():
    ...
    result = schema_validate_json(valid_json_correct_sample, resume_schema)
    logger.success(json.dumps(make_serializable(result), indent=2))
