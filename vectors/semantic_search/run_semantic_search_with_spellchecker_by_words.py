from jet.vectors.semantic_search.vector_search_with_spellchecker_by_words import SpellCorrectedSearchEngine
...
def main():
    ...
    for keyword in keywords:
        ...
        for result in results:
            print(
                f"Rank {result['rank']}: {result['text']} (Score: {result['score']:.2f})")
