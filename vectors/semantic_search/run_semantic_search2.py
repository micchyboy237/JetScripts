...
class RAGPreprocessor:
    ...
    def preprocess_for_rag(self, document: str) -> List[Chunk]:
        ...
        """
        blob = self.create_blob(document)  # Use SentenceTokenizer for splitting
        chunks: List[Chunk] = []
...
if __name__ == "__main__":
    ...
    docs: List[HeaderDoc] = derive_by_header_hierarchy(md_content, ignore_links=True)
    ...
    sentences: List[str] = [blob.sentences for text in texts for blob in TextBlob(text)]
