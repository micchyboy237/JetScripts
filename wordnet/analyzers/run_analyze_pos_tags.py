...
if __name__ == '__main__':
    ...
    includes_pos = ['PROPN', 'NOUN']

    analyze_pos_tags(texts, n=2, from_start=True,
                     words_only=True, includes_pos=includes_pos, output_dir=output_dir)
    ...
    analyze_pos_tags(texts, n=2, from_start=False,
                     words_only=True, includes_pos=includes_pos, output_dir=output_dir)
    analyze_pos_tags(texts, n=1, from_start=False,
                     excludes_pos=excludes_pos, includes_pos=includes_pos, output_dir=output_dir)
    analyze_pos_tags(texts, n=2, from_start=False,
                     excludes_pos=excludes_pos, includes_pos=includes_pos, output_dir=output_dir)
