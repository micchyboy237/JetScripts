...
from jet.code.html_to_markdown_parser import parse_markdown_file, convert_html_to_markdown, process_html_for_parsing
...
if __name__ == "__main__":
    ...
    output_result_path = f"{output_dir}/result.json"
    output_result_path2 = f"{output_dir}/result2.json"

    markdown_text = convert_html_to_markdown(sample_html)
    save_file(markdown_text, output_md_path)

    result = parse_markdown_file(output_md_path)
    save_file(result, output_result_path)

    result2 = process_html_for_parsing(sample_html, output_md_path2)
    save_file(result2, output_result_path2)
