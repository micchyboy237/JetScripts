# JetScripts/libs/llama_cpp/llm/sync/run_chat_with_tools_stream.py
...
def run_chat_with_tools_stream(
    ...
    """Synchronous streaming chat with tool calling (matches run_chat_with_tools)."""
    ...
    print("Streaming tool-augmented response:")
    chunks = llm.chat_with_tools(
        messages=messages,
        tools=tools,
...
if __name__ == "__main__":
    ...
    result = run_chat_with_tools_stream(example_messages)
