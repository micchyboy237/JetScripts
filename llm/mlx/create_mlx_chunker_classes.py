...
from jet.llm.mlx.token_utils import get_tokenizer_fn
...
def run_generate_chunker_class(
    query: str, json_file_or_dir: str
) -> Generator[GeneratorGenerationResult, None, None]:
    chunk_size = 300
