...
def paraphrase(
    ...
    """
    Paraphrases the given prompt using the specified model and method.

    Args:
        prompt: The prompt to be paraphrased.
    ...
    Returns:
        AnswerResult containing the paraphrased answer, token ID, validity, method, and any error.
    """
    try:
        ...
        choice_token_map = encode_choices(prompt,