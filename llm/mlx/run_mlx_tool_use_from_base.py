...
model = MLX(checkpoint, log_dir=f"{OUTPUT_DIR}/chats")
...
save_file(response, f"{OUTPUT_DIR}/tool_select_response.txt")
...
save_file(tool_result, f"{OUTPUT_DIR}/tool_result.txt")
...
logger.success(response)
save_file(response, f"{OUTPUT_DIR}/tool_calls_response.txt")
