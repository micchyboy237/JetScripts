...
from jet.llm.query.retrievers import setup_recursive_query
...
if __name__ == "__main__":
    ...
    output_dir = "generated/run_recursive_retriever_search"
    extensions = [".md"]
    ...
    documents = SimpleDirectoryReader(
        data_dir, required_exts=extensions).load_data()

    query_nodes = setup_recursive_query(
        data_dir, use_cache=False, output_dir=output_dir)
    ...
    result = query_nodes(sample_query)
