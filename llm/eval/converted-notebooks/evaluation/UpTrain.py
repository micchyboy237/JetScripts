...
# **This notebook uses the Ollama API to generate text for prompts as well as to create the Vector Store Index. So, set openai.api_key to your Ollama API key.**

openai.api_key = "sk-************************"  # your Ollama API key
...
#
# You can use the open-source evaluation service to evaluate your model. In this case, you will need to provide an Ollama API key. You can get yours [here](https://platform.openai.com/account/api-keys).
#
