...
extract_llm = Ollama(model="llama3.1", request_timeout=300.0, context_window=4096, temperature=0.0)
generate_llm = Ollama(model="llama3.1", request_timeout=300.0, context_window=4096, temperature=0.3)
...
index = PropertyGraphIndex.from_documents(
    ...
    kg_extractors=[
        SchemaLLMPathExtractor(
            llm=Ollama(model="llama3.1", request_timeout=300.0, context_window=4096, temperature=0.0),
