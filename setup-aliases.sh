...
large_folders() {
    ...
    # Example:
    # large_folders -b ~ -s 100 -d 0
    # large_folders -b ~ -s 100 -i "*cache*,*tmp*,*Temp*,*.TemporaryItems,Temporary Files,.Spotlight-V100,.fseventsd,.DS_Store,Logs,DerivedData,.npm,.node-gyp,.Trash" -d 0 --save
