...
"""
logger.info("# Frequently Asked Questions")
...
"""
logger.info("## **Which embedding model should I choose?**")
...
"""
logger.info("## **How do I reduce topic outliers?**")
...
"""
logger.info("Although this will lower outliers found in the data, this might force outliers to be put into topics where they do not belong. So make")
...
"""
logger.info("Third, we can replace HDBSCAN with any other clustering algorithm that we want. So we can choose a clustering algorithm, like k-Means, that")
...
"""
logger.info("## **How do I remove stop words?**")
...
"""
logger.info("We can also use the `ClassTfidfTransformer` to reduce the impact of frequent words. The result is very similar to explicitly removing stop words but this process does this automatically:")
...
"""
logger.info("## **How can I speed up BERTopic?**")
...
"""
logger.info("## **I am facing memory issues. Help!**")
...
"""
logger.info("## **I have only a few topics, how do I increase them?**")
...
"""
logger.info("## **Numpy gives me an error when running BERTopic**")
...
"""
logger.info("Then, pass it to BERTopic:")
...
"""
logger.info("## **Can I use the GPU to speed up the model?**")
...
"""
logger.info("Depending on the embeddings you are using, you might want to normalize them first to force a cosine-related distance metric in UMAP:")
...
"""
logger.info("## **How can I use BERTopic with Chinese documents?**")
...
"""
logger.info("Next, we pass our custom vectorizer to BERTopic and create our topic model:")
...
"""
logger.info("## **Why does it take so long to import BERTopic?**")
