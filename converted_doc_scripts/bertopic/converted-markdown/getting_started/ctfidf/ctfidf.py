...
"""
logger.info("### reduce_frequent_words")
...
"""
logger.info("Both parameters can be used simultaneously: `ClassTfidfTransformer(bm25_weighting=True, reduce_frequent_words=True)`")
