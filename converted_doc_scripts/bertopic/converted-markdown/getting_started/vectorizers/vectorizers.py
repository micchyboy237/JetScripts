...
"""
logger.info("Passing it after training allows you to fine-tune the topic representations by using `.update_topics()`:")
...
"""
logger.info("Now, let's see the top 10 most frequent topics that have been generated:")
...
"""
logger.info("As you might have noticed, I also added `stop_words="english"`. This is necessary as longer words tend to have many stop words and removing them allows")
...
"""
logger.info("Although they look very similar, if we zoom in on topic 8, we can see longer words in our representation:")
...
"""
logger.info("After running the above, we get the following output:")
...
"""
logger.info("With the following topic representation:")
...
"""
logger.info("With the following representation:")
...
"""
logger.info("Then, we can simply pass the vectorizer to update our topic representations:")
...
"""
logger.info("## **OnlineCountVectorizer**")
