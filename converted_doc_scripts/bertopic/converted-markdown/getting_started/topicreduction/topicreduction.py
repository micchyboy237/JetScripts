...
"""
logger.info("### **Manual Topic Reduction**")
...
"""
logger.info("It is also possible to manually select certain topics that you believe should be merged.")
...
"""
logger.info("If you have several groups of topics you want to merge, create a list of lists instead:")
...
"""
logger.info("### **Automatic Topic Reduction**")
...
"""
logger.info("### **Topic Reduction after Training**")
...
"""
logger.info("The reasoning for putting `docs` as a parameter is that the documents are not saved within")
