...
"""
logger.info("An important aspect of BERTopic is the dimensionality reduction of the input embeddings. As embeddings are often high in dimensionality, clustering becomes difficult due to the curse of dimensionality.")
...
"""
logger.info("## **Skip dimensionality reduction**")
...
<br>
"""
logger.info("In other words, we go from this pipeline:")
