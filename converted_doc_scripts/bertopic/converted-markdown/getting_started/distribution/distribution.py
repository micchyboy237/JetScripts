...
"""
logger.info("After doing so, we can approximate the topic distributions for your documents:")
...
"""
logger.info("The resulting `topic_distr` is a *n* x *m* matrix where *n* are the documents and *m* the topics. We can then visualize the distribution")
...
"""
logger.info("Although a topic distribution is nice, we may want to see how each token contributes to a specific topic. To do so, we need to first")
...
"""
logger.info("### **use_embedding_model**")
