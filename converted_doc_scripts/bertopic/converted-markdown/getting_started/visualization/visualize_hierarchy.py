...
"""
logger.info("The topics that you create can be hierarchically reduced. In order to understand the potential hierarchical")
...
"""
logger.info("The visualization above was generated with the additional parameter `hide_document_hover=True` which disables the")
