...
"""
logger.info("We can visualize the selected terms for a few topics by creating bar charts out of the c-TF-IDF scores")
...
"""
logger.info("This visualization was heavily inspired by the "Term Probability Decline" visualization found in an")
