...
llm = ChatLlamaCpp(
    model_path=r"C:\Users\druiv\.cache\llama.cpp\bartowski_Llama-3.2-3B-Instruct-GGUF_Llama-3.2-3B-Instruct-Q4_K_M.gguf",
    temperature=0
)
...
from original.embeddings import EmbedLlamaCpp
...
console.print("\n[bold blue]Agent query result:[/bold blue]")
pprint(result)
# format_messages(result['messages'])
