...
"""
logger.info("# Relevant Segment Extraction (RSE)")
...
"""
logger.info("We define a few helper functions. We'll use the Cohere Rerank API to calculate relevance values for our chunks. Normally, we'd start with a vector and/or keyword search to narrow down the list of candidates, but since we're just dealing with a single document here we can just send all chunks directly to the reranker, keeping things a bit simpler.")
...
"""
logger.info("# Visualize chunk relevance distribution across single document")
...
"""
logger.info("### How to interpret the chunk relevance plot above")
...
"""
logger.info("### Let's see what this part of the document contains")
...
"""
logger.info("### What can we do with these clusters of relevant chunks?")
...
"""
logger.info("### What if the answer is contained in a single chunk?")
