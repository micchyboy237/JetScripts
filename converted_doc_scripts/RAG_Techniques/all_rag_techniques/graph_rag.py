...
"""
logger.info("# GraphRAG: Graph-Enhanced Retrieval-Augmented Generation")
...
class DocumentProcessor:
    def __init__(self):
        """
        Initializes the DocumentProcessor with a text splitter and Ollama embeddings.
...
class KnowledgeGraph:
    ...
    def _load_spacy_model(self):
        ...
        try:
            ...
            logger.debug("Downloading spaCy model...")
...
"""
logger.info("### Define the Query Engine class")
...
"""
logger.info("### Define the Visualizer class")
...
"""
logger.info("### Create a graph RAG instance")
...
"""
logger.info("### Process the documents and create the graph")
