...
"""
logger.info("### Visual Representation")
...
"""
logger.info("### Check what our doc looklike")

logger.debug(f"Title: {docs[0].metadata['title']}\n\nSource: {docs[0].metadata['source']}\n\nContent: {docs[0].page_content}\n")

"""
### Check document relevancy
"""
logger.info("### Check document relevancy")
...
"""
logger.info("### Filter out the non-relevant docs")
...
### Highlight used docs
"""
logger.info("### Highlight used docs")
...
"""
logger.info("### Text segment in the source")
