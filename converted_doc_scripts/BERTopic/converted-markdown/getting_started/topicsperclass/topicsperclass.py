...
"""
logger.info("In some cases, you might be interested in how certain topics are represented over certain categories. Perhaps")
...
"""
logger.info("Next, we want to extract the topics across all documents without taking the categories into account:")
...
"""
logger.info("Now that we have created our global topic model, let us calculate the topic representations across each category:")
...
"""
logger.info("The `classes` variable contains the class for each document. Then, we simply visualize these topics per class:")
...
"""
logger.info("You can hover over the bars to see the topic representation per class.")
