...
"""
logger.info("You may want to install more depending on the transformers and language backends that you will be using.")
...
"""
logger.info("After generating topics, we can access the frequent topics that were generated:")
...
"""
logger.info("frequent topic that was generated, topic 0:")
...
"""
logger.info("Using `.get_document_info`, we can also extract information on a document level, such as their corresponding topics, probabilities, whether they are representative documents for a topic, etc.:")
...
"""
logger.info("## **Fine-tune Topic Representations**")
...
"""
However, you might want to use something more powerful to describe your clusters. You can even use ChatGPT or other models from Ollama to generate labels, summaries, phrases, keywords, and more:
"""
logger.info("However, you might want to use something more powerful to describe your clusters. You can even use ChatGPT or other models from Ollama to generate labels, summaries, phrases, keywords, and more:")


client = ollama.Ollama()
representation_model = Ollama(client, model="llama3.2", chat=True)
topic_model = BERTopic(representation_model=representation_model)
...
"""
logger.info("## **Save/Load BERTopic model**")
...
"""
logger.info("When saving the model, make sure to also keep track of the versions of dependencies and Python used.")
