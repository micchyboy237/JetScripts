...
"""
logger.info("# Merge Multiple Fitted Models")
...
"""
logger.info("When we inspect the first model, we can see it has 52 topics:")
...
"""
logger.info("Now, we inspect the merged model, we can see it has 57 topics:")
...
Let's inspect them:
"""
logger.info("It seems that by merging these three models, there were 6 undiscovered topics that we could add to the very first model.")
...
"""
logger.info("When we inspect the number of topics in our new model, we can see that they have increased quite a bit:")
...
"""
logger.info("This demonstrates the influence of `min_similarity` on the number of new topics that are added to the base model.")
