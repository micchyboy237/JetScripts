...
"""
logger.info("Then, we can call `.visualize_topics` to create a 2D representation of your topics. The resulting graph is a")
...
"""
logger.info("## **Visualize Topic Hierarchy**")
...
"""
logger.info("### **Hierarchical labels**")
...
"""
logger.info("To visualize these results, we simply need to pass the resulting `hierarchical_topics` to our `.visualize_hierarchy` function:")
...
"""
logger.info("## **Visualize Hierarchical Documents**")
...
"""
logger.info("Then, we can visualize the hierarchical documents by either supplying it with our embeddings or by")
...
"""
logger.info("## **Visualize Topic Similarity**")
...
"""
logger.info("## **Visualize Term Score Decline**")
...
"""
logger.info("To enable the log scale on the y-axis for a better view of individual topics, run the following:")
...
"""
logger.info("## **Visualize Topics over Time**")
...
"""
logger.info("Then, we visualize some interesting topics:")
...
First, we need to train our model:
"""
logger.info("## **Visualize Topics per Class**")
...
"""
logger.info("Then, we visualize the topic representation of major topics per class:")
