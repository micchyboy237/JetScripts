...
# !mkdir -p data
# !wget -O f"{DATA_DIR}/10k-132.pdf" "https://www.dropbox.com/scl/fi/6dlqdk6e2k1mjhi8dee5j/uber.pdf?rlkey=2jyoe49bg2vwdlz30l76czq6g&dl=1"
# !wget -O f"{DATA_DIR}/10k-vFinal.pdf" "https://www.dropbox.com/scl/fi/qn7g3vrk5mqb18ko4e5in/lyft.pdf?rlkey=j6jxtjwo8zbstdo4wz3ns8zoj&dl=1"

uber_docs = SimpleDirectoryReader(
    input_files=[f"{DATA_DIR}/10k-132.pdf"]).load_data()
...
lyft_docs = SimpleDirectoryReader(
    input_files=[f"{DATA_DIR}/10k-vFinal.pdf"]
).load_data()
...
logger.debug(response_no_metadata.response)
