...
async def run_workflow():
    ...
    logger.newline()
    logger.info("Handler (chemistry):")
    logger.success(await handler)
    ...
    logger.success(format_json(wflow_ckptr.checkpoints))
    ...
    logger.newline()
    logger.info("Checkpoints after joke step:")
    ...
    logger.newline()
    logger.info("Handler after joke step:")
    logger.success(await handler)

    for run_id, ckpts in wflow_ckptr.checkpoints.items():
        print(f"Run: {run_id} has {len(ckpts)} stored checkpoints")
        logger.log("Run:", run_id, "has", len(ckpts), "stored checkpoints",
    ...
    logger.newline()
    logger.info("Enabled checkpoints:")
    logger.success(format_json(wflow_ckptr.enabled_checkpoints))
    ...
    logger.newline()
    logger.info("Handler disabled critique_joke (cars):")
    logger.success(await handler)
    ...
    logger.newline()
    logger.info("Handler enabled critique_joke (cars):")
    logger.success(await handler)
