...
Wikipedia Text embedding index: Generate GPT text embeddings from MLX for texts

Wikipedia Images embedding index: [CLIP](https://github.com/openai/CLIP) embeddings from MLX for images
