...
## Installation
"""
logger.info("# Multi-Modal RAG System")
...
"""
logger.info("## Load Images with `urls`")
...
"""
logger.info("## Querying with `GPT-4V` vision API.")

openai_mm_llm = MLXMultiModal(
    model="qwen3-1.7b-4bit", log_dir=f"{OUTPUT_DIR}/chats", max_new_tokens=300
)
...
"""
logger.info("## Load Images from directory")
...
"""
logger.info("## Download Images and Text from Wikipedia")
...
"""
logger.info("## Setup Qdrant client for indexing")
...
"""
logger.info("## Load Images and Text Documents")
...
"""
logger.info("## Create Multi-Modal Index")
