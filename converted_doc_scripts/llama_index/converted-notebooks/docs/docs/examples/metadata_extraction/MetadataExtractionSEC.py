...
"""
logger.info("We create a node parser that extracts the document title and hypothetical question embeddings relevant to the document chunk.")
...
"""
logger.info("## Querying an Index With No Extra Metadata")
...
"""
logger.info("## Querying an Index With Extracted Metadata")
...
"""
logger.info("### Challenges Identified in the Problem Domain")
