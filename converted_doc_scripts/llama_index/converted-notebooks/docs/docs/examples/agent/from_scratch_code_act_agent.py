...
class CodeActAgent(Workflow):
    ...
    async def handle_llm_input(
        ...
        async def run_async_code_c355cf84():
            async def run_async_code_4abaceee():
                response_stream = self.llm.stream_chat(chat_history)
                return response_stream
            response_stream = asyncio.run(run_async_code_4abaceee())
            logger.success(format_json(response_stream))
            return response_stream
        response_stream = asyncio.run(run_async_code_c355cf84())
        logger.success(format_json(response_stream))
...
async def async_func_29():
    ...
    return response
response = asyncio.run(async_func_29())
logger.success(format_json(response))
...
async def async_func_33():
    ...
    return response
response = asyncio.run(async_func_33())
logger.success(format_json(response))
