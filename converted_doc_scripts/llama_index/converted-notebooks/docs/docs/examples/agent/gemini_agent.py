...
Build a Anthropic agent over a simple 10K document. We use MLX embeddings and Gemini 2.0 Flash to construct the RAG pipeline, and pass it to the Gemini 2.5 Flash agent as a tool.
"""
...
embed_model = MLXEmbedding(model_name="text-embedding-3-large")
