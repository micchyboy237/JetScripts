...
For LLMs like MLX that have a function calling API, we should use the `FunctionAgent`.
...
agent = FunctionAgent(tools=query_engine_tools, llm=MLX(model="qwen3-1.7b-4bit"))
