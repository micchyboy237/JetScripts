...
The following example uses MLX embedding for semantic search and BM25 for full-text search:
"""
...
index = VectorStoreIndex.from_documents(
    ...
    embed_model="default",  # "default" will use MLX embedding
)
...
- `embedding`: Dense embeddings generated by MLX embedding model for semantic search.
