...
The following example uses OllamaFunctionCallingAdapter embedding for semantic search and BM25 for full-text search:
"""
...
index = VectorStoreIndex.from_documents(
    ...
    embed_model="default",  # "default" will use OllamaFunctionCallingAdapter embedding
)
...
- `embedding`: Dense embeddings generated by OllamaFunctionCallingAdapter embedding model for semantic search.
