...
In this section, we will store sample data in Milvus using the default embedding model (MLX's `text-embedding-ada-002`). Titles will be converted into text embeddings and stored in a dense embedding field, while all metadata will be stored in scalar fields.
"""
