...
"""
logger.info("# Property Graph Construction with Predefined Schemas")
...
"""
logger.info("Now, You can use SimplePropertyGraph, Neo4j, or NebulaGraph to store the graph.")
...
"""
logger.info("To launch NebulaGraph locally, first ensure you have docker installed. Then, you can launch the database with the following docker command.")
...
"""
logger.info("If we inspect the graph created, we can see that it only includes the relations and entity types that we defined!")
...
"""
logger.info("We can also create a query engine with similar syntax.")
...
"""
logger.info("For more info on all retrievers, see the [complete guide](/../../module_guides/indexing/lpg_index_guide#retrieval-and-querying).")
