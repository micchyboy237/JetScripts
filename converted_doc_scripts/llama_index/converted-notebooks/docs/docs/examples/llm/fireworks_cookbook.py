async def main():
    ...
    Fireworks.ai supports function calling for its LLMs, similar to OllamaFunctionCallingAdapter. This lets users directly describe the set of tools/functions available and have the model dynamically pick the right function calls to invoke, without complex prompting on the user's part.
    
    Since our Fireworks LLM directly subclasses OllamaFunctionCallingAdapter, we can use our existing abstractions with Fireworks.
    ...
    """
    ## Using An OllamaFunctionCallingAdapter Agent
    """
    logger.info("## Using An OllamaFunctionCallingAdapter Agent")
