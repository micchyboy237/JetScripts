...
async def run_async_code_fddef51c():
    async def run_async_code_e567aab9():
        response = llm.complete("Tell me a joke")
        return response
    response = asyncio.run(run_async_code_e567aab9())
    logger.success(format_json(response))
    return response
response = asyncio.run(run_async_code_fddef51c())
logger.success(format_json(response))
...
async def run_async_code_f6f09a08():
    for chunk in llm.stream_complete("Tell me a joke"):
    return 
 = asyncio.run(run_async_code_f6f09a08())
...
async def async_func_51():
    ...
    return response
response = asyncio.run(async_func_51())
logger.success(format_json(response))
