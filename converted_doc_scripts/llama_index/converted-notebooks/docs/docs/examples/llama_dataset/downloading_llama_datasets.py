...
prediction_dataset = asyncio.run(async_func_4())
...
"""
logger.info("Loop through the (`labelled_example`, `prediction`) pais and perform the evaluations on each of them individually.")
...
"""
logger.info("Now, we can use our notebook utility functions to view these evaluations.")
...
async def async_func_8():
    ...
    return benchmark_df
benchmark_df = asyncio.run(async_func_8())
