async def main():
    ...
    **NOTE**: We pull this in from Dropbox. For details on how to generate a dataset please see our `DatasetGenerator` module.
    ...
    def _get_eval_batch_runner():
        evaluator_s = SemanticSimilarityEvaluator(embed_model=HuggingFaceEmbedding(model_name="sentence-transformers/all-MiniLM-L6-v2", cache_folder=MODELS_CACHE_DIR))
