...
"""
logger.info("# [Beta] Text-to-SQL with PGVector")
...
logger.debug(nodes[8].get_content(metadata_mode="all"))
...
"""
logger.info("### Insert data into Postgres + PGVector")
...
"""
logger.info("#### Define Table Schema")
...
"""
logger.info("## Define PGVectorSQLQueryEngine")
...
### Define Query Engine
"""
logger.info("### Define Query Engine")
...
logger.debug(response.metadata["sql_query"][:300])

logger.debug(response.metadata["result"])
