...
"""
logger.info("### RAG: Multimodal Search on Videos and Stream Video Results 📺")
...
"""
logger.info("## 🛠 Using VideoDBRetriever to Build RAG for Single Video")
...
"""
logger.info("### 🗣️ Step 2: Indexing & Search from Spoken Content")

logger.debug("Indexing spoken content in Video...")
...
"""
logger.info("#### 🗣️ Retrieving Relevant Nodes from Spoken Index")
...
"""
logger.info("#### 🗣️️️ Viewing the result : 💬 Text")
...
"""
logger.info("#### 🗣️ Viewing the result : 🎥 Video Clip")
...
"""
logger.info("### 📸️ Step3 : Index & Search from Visual Content")


logger.debug("Indexing Visual content in Video...")
...
logger.debug(f"Scene Index successful with ID: {index_id}")
...
logger.debug("Query for Spoken retriever : ", spoken_query)
logger.debug("Query for Scene retriever : ", scene_query)

"""
##### 🔎 Finding Relevant nodes for each modality
"""
logger.info("##### 🔎 Finding Relevant nodes for each modality")
...
"""
logger.info("## 🛠 Using VideoDBRetriever to Build RAG for Collection of Videos")
...
#### 🗣️ Indexing Spoken Content
"""
logger.info("#### 🗣️ Indexing Spoken Content")
...
"""
logger.info("#### 🔎 Finding relevant nodes")
...
"""
logger.info("## Configuring `VideoDBRetriever`")
