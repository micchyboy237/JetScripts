...
"""
logger.info("# Reciprocal Rerank Fusion Retriever")
...
"""
logger.info("## Create a Hybrid Fusion Retriever")
...
"""
logger.info("Next, we can create our fusion retriever, which well return the top-2 most similar nodes from the 4 returned nodes from the retrievers:")
...
for node in nodes_with_scores:
    logger.debug(f"Score: {node.score:.2f} - {node.text}...\n-----\n")
