...
async def async_func_0():
    ...
    return nodes
nodes = asyncio.run(async_func_0())
...
"""
logger.info("Define retriever query engine to integrate the recursive retriever + reranker together.")
...
async def async_func_56():
    ...
    return eval_results
eval_results = asyncio.run(async_func_56())
...
base_eval_results = asyncio.run(async_func_62())
...
pairwise_eval_results = asyncio.run(async_func_79())
