...
"""
logger.info("# Building Evaluation from Scratch")
...
def generate_qa_pairs(
    ...
    for idx, node in enumerate(nodes):
        logger.debug(f"Node {idx}/{len(nodes)}")
...
"""
logger.info("### Getting Pairs over Dataset")
...
"""
logger.info("#### [Optional] Define save/load")
...
logger.debug(str(generated_answer))
...
"""
logger.info("### Building a Faithfulness Evaluator")
...
"""
logger.info("Let's try it out on some data")
...
"""
logger.info("## Running Evaluation over our Eval Dataset")
