...
"""
logger.info("# Building a Router from Scratch")
...
"""
logger.info("## 2. A Router Prompt that can generate structured outputs")
...
"""
logger.info("### 2.b Define Router Output Parser")
...
"""
logger.info("### Setup: Define Indexes")
...
"""
logger.info("### Define RouterQueryEngine")
...
"""
logger.info("### Try our constructed Router Query Engine")
