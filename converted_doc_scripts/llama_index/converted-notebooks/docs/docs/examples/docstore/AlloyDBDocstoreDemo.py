...
"""
logger.info("# Google AlloyDB for PostgreSQL - `AlloyDBDocumentStore` & `AlloyDBIndexStore`")
...
"""
logger.info("### Initialize a default AlloyDBDocumentStore")
...
async def async_func_2():
    ...
    return doc_store
doc_store = asyncio.run(async_func_2())
...
async def async_func_8():
    ...
    return index_store
index_store = asyncio.run(async_func_8())
