async def main():
    ...
    **NOTE:** With loops, we need to be mindful of runtime. Here, we set a timeout of 120s.
    ...
    agent = ReActAgent(
        llm=OllamaFunctionCallingAdapter(model="llama3.2", request_timeout=300.0, context_window=4096), tools=tools, timeout=120, verbose=True
    )
    ...
    agent = ReActAgent(
        llm=OllamaFunctionCallingAdapter(model="llama3.2", request_timeout=300.0, context_window=4096), tools=tools, timeout=120, verbose=False
    )
