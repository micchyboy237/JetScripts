...
"""
logger.info("# RAGChecker: A Fine-grained Evaluation Framework For Diagnosing RAG")
...
"""
logger.info("## Creating a LlamaIndex Query Engine")
...
"""
logger.info("## Using RAGChecker with LlamaIndex")
...
"""
logger.info("## Evaluating with RAGChecker")
...
"""
logger.info("### Selecting Specific Metric Groups")
...
"""
logger.info("### Selecting Individual Metrics")
