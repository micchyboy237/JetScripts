...
"""
logger.info("# Vector Store Index usage examples")
...
"""
logger.info("You can use a custom vector store (in this case `PineconeVectorStore`) as follows:")
...
"""
logger.info("## Connect to external vector stores (with existing embeddings)")
...
"""
logger.info("To configure query settings, you can directly pass it as")
...
"""
logger.info("Note that metadata filtering is applied against metadata specified in `Node.metadata`.")
...
"""
logger.info("You can customize keyword arguments unique to a specific vector store implementation as well by passing in `vector_store_kwargs`")
...
"""
logger.info("You can also use an LLM to automatically decide query setting for you!")
