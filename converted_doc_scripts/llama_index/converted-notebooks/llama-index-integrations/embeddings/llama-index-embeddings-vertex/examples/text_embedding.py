...
async def run_async_code_446b746b():
    async def run_async_code_8ef69c62():
        result = await embed_model.aget_text_embedding("Hello World!")
        return result
    result = asyncio.run(run_async_code_8ef69c62())
    logger.success(format_json(result))
    return result
result = asyncio.run(run_async_code_446b746b())
logger.success(format_json(result))
