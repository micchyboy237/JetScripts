...
Image.open("./input_images/performance_spec.png")

Image.open("./input_images/price.png")

llm = HuggingFaceMultiModal.from_model_name("Qwen/Qwen2-VL-2B-Instruct")


image_documents = SimpleDirectoryReader("./input_images").load_data(show_progress=True)

llm_response = llm.complete("Describe the images", image_documents=image_documents)
