...
There are [many types of embeddings](/python/framework/module_guides/models/embeddings), and they vary in efficiency, effectiveness and computational cost. By default LlamaIndex uses `text-embedding-ada-002`, which is the default embedding used by Ollama. If you are using different LLMs you will often want to use different embeddings.
...
"""
logger.info("You can also choose to build an index over a list of Node objects directly:")
