...
"""
logger.info("# Response Synthesizer")
...
"""
logger.info("Or in a query engine after you've created an index:")
...
"""
logger.info("Or, more commonly, in a query engine after you've created an index:")
...
"""
logger.info("## Configuring the Response Mode")
...
This option is particularly useful if you're using an [Ollama model that supports function calling](https://ollama.com/blog/function-calling-and-other-api-updates). Other LLM providers or models that don't have native function calling support may be less reliable in producing the structured response this feature relies on.
...
For example,
"""
logger.info("## Using Structured Answer Filtering")
