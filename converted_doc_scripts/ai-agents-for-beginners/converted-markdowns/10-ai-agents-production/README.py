...
"""
logger.info("# AI Agents in Production: Observability & Evaluation")
...
"""
logger.info("The [example notebook](./code_samples/10_autogen_evaluation.ipynb) in this chapter will demonstrate how to instrument your AutoGen agent.")
