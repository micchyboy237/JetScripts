...
Thanks to GitHub Models, all you need to build your first AI Agent is a GitHub account! GitHub Models includes powerful models like Ollama gpt-4o, DeepSeek-R1, Llama-3.1, and many more, ready to try out in the playground or in your code.
...
"""
logger.info("## Event Name: Build your code-first app with Azure AI Agent Service (EMEA/US offering)")
