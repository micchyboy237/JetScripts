...
3. Search for the `llama3.1` model in the list, and then select and confirm it.
...
2. Click **+ Create agent** to create a new agent. Under the **Agent Setup** dialog box:
    ...
    - Ensure that the `llama3.1` model deployment you created previously is selected
...
"""
logger.info("# Azure AI Agent Service Development")
