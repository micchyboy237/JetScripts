...
class SavePlugin:
    ...
    async def saving_plan(self,tripplan: Annotated[str, "The content of trip plan"])-> Annotated[str, "Return status of save content"]:
        ...
        result = asyncio.run(async_func_5())
        logger.success(format_json(result))
            ...
            agent_definition = asyncio.run(async_func_15())
            ...
            async def run_async_code_d1beaa2a():
                async def run_async_code_c1a853c3():
                    thread = await client.agents.create_thread()
                    return thread
                thread = asyncio.run(run_async_code_c1a853c3())
                logger.success(format_json(thread))
                return thread
            thread = asyncio.run(run_async_code_d1beaa2a())
            logger.success(format_json(thread))
            ...
            try:
                for user_input in user_inputs:
                    ...
                    async def run_async_code_fe2617d4():
                        async def run_async_code_a8882086():
                            messages = await client.agents.list_messages(thread_id=thread.id)
                            return messages
                        messages = asyncio.run(run_async_code_a8882086())
                        logger.success(format_json(messages))
                        return messages
                    messages = asyncio.run(run_async_code_fe2617d4())
                    logger.success(format_json(messages))
                    ...
                    for file_path_annotation in messages.file_path_annotations:
                            ...
                            async def run_async_code_5e6da717():
                                await client.agents.save_file(file_id=file_path_annotation.file_path.file_id, file_name=file_name,target_dir="./trip")
                                return 
                             = asyncio.run(run_async_code_5e6da717())
                            logger.success(format_json())


            finally:
                async def run_async_code_b328da36():
                    await client.agents.delete_thread(thread.id)
                    return 
                 = asyncio.run(run_async_code_b328da36())
                logger.success(format_json())
                async def run_async_code_2421882c():
                    await client.agents.delete_agent(agent.id)
                    return 
                 = asyncio.run(run_async_code_2421882c())
                logger.success(format_json())
...
logger.success(format_json(result))
    ...
    async def async_func_29():
        ...
        return booking_agent_definition
    booking_agent_definition = asyncio.run(async_func_29())
    ...
    save_agent_definition = asyncio.run(async_func_42())
    ...
    try:
        ...
        async def run_async_code_69c2b46b():
            await chat.reset()
            return 
         = asyncio.run(run_async_code_69c2b46b())
        logger.success(format_json())
        async def run_async_code_030d4cf7():
            await client.agents.delete_agent(save_agent.id)
            return 
         = asyncio.run(run_async_code_030d4cf7())
        logger.success(format_json())
        async def run_async_code_2f6dfa24():
            await client.agents.delete_agent(booking_agent.id)
            return 
         = asyncio.run(run_async_code_2f6dfa24())
        logger.success(format_json())
