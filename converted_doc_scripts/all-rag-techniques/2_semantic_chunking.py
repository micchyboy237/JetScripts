...
from helpers import (
    ...
    DATA_DIR, DOCS_PATH, SearchResult
)
...
def perform_semantic_search(
    ...
    """Perform semantic search on text chunks using query embedding."""
    ...
    return [{"id": f"chunk_{i}", "rank": idx + 1, "doc_index": i, "score": similarities[i],
             "text": text_chunks[i], "metadata": {}, "relevance_score": None}
