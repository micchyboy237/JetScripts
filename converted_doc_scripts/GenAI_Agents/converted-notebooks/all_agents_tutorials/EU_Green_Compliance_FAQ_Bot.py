...
summarizer = SummarizerAgent(model="llama3.2")
...
#         self.ollama_api_key = ollama_api_key or os.getenv("OPENAI_API_KEY")
        ...
        if not self.ollama_api_key:
            raise ValueError(
                "Ollama API key is required for rephrasing queries.")
    ...
    def rephrase_query(self, query: str) -> str:
        ...
        rephrased_query = self._send_ollama_request(
            prompt, model="llama3.2", max_tokens=60)
