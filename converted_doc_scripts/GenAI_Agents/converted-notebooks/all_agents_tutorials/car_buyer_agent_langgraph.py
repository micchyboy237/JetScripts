async def main():
    ...
    2. **`langchain` and `langchain-ollama`**:
       - Frameworks for developing applications powered by Language Models (LLMs). `langchain-ollama` is specifically tailored for Ollama's APIs.
