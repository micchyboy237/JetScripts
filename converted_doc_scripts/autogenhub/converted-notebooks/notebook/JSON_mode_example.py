...
```
"""
logger.info("# Mitigating Prompt hacking with JSON Mode in Autogen")
...
"""
logger.info("### Configuring the Agents")
...
### Friendly Agent
"""
logger.info("### Friendly and Suspicious Agents")
...
"""
logger.info("### Defining Allowed Speaker transitions")
...
"""
logger.info("Finally, we pass the task into message initiating the chat.")
