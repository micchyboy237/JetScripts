...
"""
logger.info("# Conversation Patterns")
...
"""
logger.info("Let's see what the summary looks like.")
...
"""
logger.info("In the above example, the summary method is set to `reflection_with_llm` which")

logger.debug(ConversableAgent.DEFAULT_SUMMARY_PROMPT)
...
"""
logger.info("You can also use a custom prompt by setting the `summary_prompt` argument")


pprint.plogger.debug(chat_result.chat_history)
...
is the "user".
"""
logger.info("That chat messages in the chat result are from the")
...
"""
logger.info("The Number Agent chats with the first operator agent, then the second")
...
"""
logger.info("First thing to note is that the `initiate_chats` method takes a list of")

logger.debug("First Chat Summary: ", chat_results[0].summary)
logger.debug("Second Chat Summary: ", chat_results[1].summary)
logger.debug("Third Chat Summary: ", chat_results[2].summary)
logger.debug("Fourth Chat Summary: ", chat_results[3].summary)
...
"""
logger.info("We first create a `GroupChat` object and provide the list of agents.")
...
"""
logger.info("Now we create a `GroupChatManager` object and provide the `GroupChat` object as")
...
"""
logger.info("Finally, we have the Number Agent from before to start a two-agent chat with")
...
"""
logger.info("You can see that the Number Agent is selected to speak first, then the")
...
"""
logger.info("### Send Introductions")
...
"""
logger.info("### Group Chat in a Sequential Chat")
...
Here is an example:
"""
logger.info("### Constrained Speaker Selection")
...
"""
logger.info("In this example, the allowed transitions are specified for each agent.")
...
"""
logger.info("### Changing the select speaker role name")
...
"""
logger.info("Now we define the nested chats using the sequential chat pattern.")
...
"""
logger.info("Now we register the nested chats handler to the `arithmetic_agent` and")
...
"""
logger.info("Finally, we call `generate_reply` to get a response from the `arithmetic_agent`")
