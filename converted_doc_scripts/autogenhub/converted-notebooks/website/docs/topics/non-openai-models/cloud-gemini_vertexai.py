...
"""
logger.info("# Use AutoGen with Gemini via VertexAI")
...
```
"""
logger.info("## Example with Gemini Multimodal")
...
<img https://github.com/autogenhub/autogen/blob/main/website/static/img/autogen_agentchat.png?raw=true>.""",
)
