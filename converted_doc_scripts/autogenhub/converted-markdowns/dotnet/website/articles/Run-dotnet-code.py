...
"""
logger.info("## What is a code snippet?")
...
"""
logger.info("## Run python code snippet")
...
"""
logger.info("After `ipykernel` and `jupyter` are installed, you can confirm the ipykernel is installed correctly by running the following command:")
...
"""
logger.info("The output should contain all available kernels, including `python3`.")
