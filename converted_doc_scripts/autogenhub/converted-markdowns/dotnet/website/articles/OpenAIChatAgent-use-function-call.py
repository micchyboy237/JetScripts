...
[!code-csharp[](../../sample/AutoGen.BasicSamples/CodeSnippet/MLXCodeSnippet.cs?name=weather_function)]
...
[!code-csharp[](../../sample/AutoGen.BasicSamples/CodeSnippet/MLXCodeSnippet.cs?name=openai_chat_agent_get_weather_function_call)]
...
[!code-csharp[](../../sample/AutoGen.BasicSamples/CodeSnippet/MLXCodeSnippet.cs?name=create_function_call_middleware)]

Finally, you can chat with the @AutoGen.MLX.MLXChatAgent and invoke the `GetWeather` function.

[!code-csharp[](../../sample/AutoGen.BasicSamples/CodeSnippet/MLXCodeSnippet.cs?name=chat_agent_send_function_call)]
"""
