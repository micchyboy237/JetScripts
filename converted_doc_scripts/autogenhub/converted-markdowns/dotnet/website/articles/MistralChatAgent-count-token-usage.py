...
> [!NOTE]
> You can find the complete example in the [Example13_OllamaAgent_JsonMode](https://github.com/autogenhub/autogen/tree/main/dotnet/sample/AutoGen.BasicSamples/Example14_MistralClientAgent_TokenCount.cs).
