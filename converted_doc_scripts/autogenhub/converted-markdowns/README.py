...
"""
logger.info("# [AutoGen](https://github.com/autogenhub/autogen)")
...
"""
logger.info("Minimal dependencies are installed without extra options. You can install extra options based on the feature you need.")
...
"""
logger.info("## Multi-Agent Conversation Framework")
...
"""
logger.info("This example can be run with")
...
"""
logger.info("## Enhanced LLM Inferences")
