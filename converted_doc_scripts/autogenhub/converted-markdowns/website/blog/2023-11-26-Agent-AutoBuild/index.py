...
"""
logger.info("### Step 3: specify the building task")
...
"""
logger.info("### Step 4: build group chat agents")
...
"""
logger.info("### Step 5: execute the task")
...
"""
logger.info("### Step 6 (Optional): clear all agents and prepare for the next task")
...
"""
logger.info("Configurations will be saved in JSON format with the following content:")
...
"""
logger.info("You can provide a specific filename, otherwise, AgentBuilder will save config to the current path with the generated filename `save_config_TASK_MD5.json`.")
...
"""
logger.info("## (Experimental) Use Open-source LLM")
...
"""
logger.info("## Future work/Roadmap")
