...
"""
logger.info("RetrieveChat can handle various types of documents. By default, it can process")
...
1. Import Agents
"""
logger.info("You can find a list of all supported document types by using `autogen.retrieve_utils.TEXT_FORMATS`.")
...
"""
logger.info("2. Create an 'AssistantAgent' instance named "assistant" and an 'RetrieveUserProxyAgent' instance named "ragproxyagent"")
...
"""
logger.info("3. Initialize Chat and ask a question")
...
"""
logger.info("### Customizing Text Split Function")
...
"""
logger.info("### Customizing Vector Database")
...
"""
logger.info("### Build a Chat application with Gradio")
