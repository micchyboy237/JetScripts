...
"""
logger.info("You can also specify the model directly in the agent's configuration as shown below.")
...
"""
logger.info("## What Can You Do with AutoGen Studio?")
...
"""
logger.info("## Road Map and Next Steps")
