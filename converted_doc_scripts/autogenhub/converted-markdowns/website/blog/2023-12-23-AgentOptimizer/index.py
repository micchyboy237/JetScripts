...
"""
logger.info("## Pseudocode for the optimization process")
...
"""
logger.info("## The implementation technology behind the AgentOptimizer")
...
"""
logger.info("2. `revise_function`: Revise one existing function (code implementation, function signature) in the current function list according to the conversation history and performance.")
...
"""
logger.info("3. `remove_function`: Remove one existing function in the current function list. It is used to remove the functions that are not useful (redundant) in the future tasks.")
