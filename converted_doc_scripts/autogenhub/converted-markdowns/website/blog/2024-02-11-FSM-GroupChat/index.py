...
3. Define the task
    ...
    # describe the task
    task = """
logger.info("# Please feel free to change it as you wish")Add 1 to the number output by the previous role. If the previous number is 20, output "TERMINATE"."""
    ```
...
4. Define agents
    ...
    engineer = AssistantAgent(
        ...
        system_message=task,
        description="""
logger.info("# agents configuration")I am **ONLY** allowed to speak **immediately** after `Planner`, `Critic` and `Executor`.
    ...
    planner = AssistantAgent(
        ...
        llm_config=gpt_config,
        description="""
logger.info("planner = AssistantAgent(")I am **ONLY** allowed to speak **immediately** after `User` or `Critic`.
    ...
    executor = AssistantAgent(
        ...
        llm_config=gpt_config,
        description="""
logger.info("executor = AssistantAgent(")I am **ONLY** allowed to speak **immediately** after `Engineer`.
    ...
    critic = AssistantAgent(
        ...
        llm_config=gpt_config,
        description="""
logger.info("critic = AssistantAgent(")I am **ONLY** allowed to speak **immediately** after `Engineer`.
    ...
    user_proxy = UserProxyAgent(
        ...
        llm_config=False,
        description="""
logger.info("user_proxy = UserProxyAgent(")
...
"""
logger.info("# create the groupchat")
