...
"""
logger.info("You can also install with different [optional dependencies](/docs/installation/Optional-Dependencies).")
...
:::
"""
logger.info("When asked, be sure to check the generated code before continuing to ensure it is safe to run.")
