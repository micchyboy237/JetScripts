...
"""
# logger.info("# Defaults to os.environ.get("OPENAI_API_KEY")")
...
2. Code-Based Uploading:Alternatively, you can upload files and retrieve their file IDs programmatically using the following code snippet:
    ...
    logger.debug("Vector Store created:", vector_store.id)  # This is your vector_store.id
    ...
    logger.debug("File batch status:", file_batch.status)
    logger.debug("Uploaded file count:", file_batch.file_counts.processed)
    ```
