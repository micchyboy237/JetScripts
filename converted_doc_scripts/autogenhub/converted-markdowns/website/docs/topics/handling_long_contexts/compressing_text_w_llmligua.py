...
"""
logger.info("# Compressing Text with LLMLingua")
...
"""
logger.info("## Example 1: Compressing AutoGen Research Paper using LLMLingua")
...
logger.debug(text_compressor.get_logs([], []))
...
"""
logger.info("## Example 2: Integrating LLMLingua with `ConversableAgent`")
...
logger.debug(result.chat_history[1]["content"])
...
"""
logger.info("## Example 3: Modifying LLMLingua's Compression Parameters")
