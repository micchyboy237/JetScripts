...
"""
logger.info("# Retrieval Augmentation")
...
"""
logger.info("### Step 2. Initiating Agent Chat with Retrieval Augmentation")
...
"""
logger.info("## Example Setup: RAG with Retrieval Augmented Agents with PGVector")
