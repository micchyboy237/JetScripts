...
"""
logger.info("# Enhanced Inference")
...
"""
logger.info("### Metric to optimize")
...
"""
logger.info("A template is either a format str, like the example above, or a function which produces a str from several input fields, like the example below.")
...
"""
logger.info("The API calls made after this will be automatically logged. They can be retrieved at any time by:")
...
"""
logger.info("There is a function that can be used to print usage summary (total cost, and token count usage from each model):")
...
To stop logging, use
"""
logger.info("To stop logging, use")
...
"""
logger.info("If one would like to append the history to an existing dict, pass the dict like:")
...
"""
logger.info("By default, the counter of API calls will be reset at `start_logging()`. If no reset is desired, set `reset_counter=False`.")
