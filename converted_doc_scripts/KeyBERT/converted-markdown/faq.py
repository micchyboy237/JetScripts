...
This is **faster**:
"""
logger.info("## **Which embedding model works best for which language?**")
...
"""
logger.info("## **How can I use KeyBERT with Chinese documents?**")
...
"""
logger.info("It also supports highlighting:")
