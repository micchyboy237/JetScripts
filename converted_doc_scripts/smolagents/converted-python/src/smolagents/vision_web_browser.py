...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        help="The model type to use (e.g., OllamaServerModel, LiteLLMModel, TransformersModel, InferenceClientModel)",
    )
    parser.add_argument(
        "--model-id",
        type=str,
...
def save_screenshot(memory_step: ActionStep, agent: CodeAgent) -> None:
    ...
    if driver is not None:
        ...
        logger.debug(f"Captured a browser screenshot: {image.size} pixels")
