...
class Tool(BaseTool):
    ...
    def to_code_prompt(self) -> str:
        ...
        if has_schema:
            tool_doc += "\n\nImportant: This tool returns structured output! Use the JSON schema below to directly access fields like result['field_name']. NO logger.debug() statements needed to inspect the output!"
