    ...
    def test_e2b_executor_instantiation(self):
        ...
        with patch("e2b_code_interpreter.Sandbox") as mock_sandbox:
            ...
            executor = E2BExecutor(
                additional_imports=[], logger=logger, template="dummy-template-id", timeout=60
            )
...
class CommonDockerExecutorIntegration:
    ...
    def test_state_persistence(self):
        ...
        code_action = "logger.debug(np.sqrt(a))"
        code_output = self.executor(code_action)
    ...
    def test_syntax_error_handling(self):
        ...
        code_action = 'logger.debug("Missing Parenthesis'  # Syntax error
...
class TestWasmExecutorIntegration:
    ...
    def test_basic_execution(self):
        ...
        code = "a = 2 + 2; logger.debug(f'Result: {a}')"
    ...
    def test_state_persistence(self):
        ...
        code_output = self.executor("logger.debug(x)")
    ...
    def test_numpy_execution(self):
        ...
        logger.debug(f"Mean: {np.mean(arr)}")
        """
        code_output = self.executor(code)
    ...
    def test_syntax_error_handling(self):
        """Test handling of syntax errors."""
        code = "logger.debug('Missing parenthesis"  # Missing closing parenthesis
        with pytest.raises(AgentError) as excinfo:
            self.executor(code)
