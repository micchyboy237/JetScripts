...
async def main():
    ...
    * [asyncio](https://docs.python.org/3/library/asyncio.html)
    ...
    """
    logger.info("# Async programming with LangChain")
    ...
    For example,
    """
    logger.info("Other components like [Embedding Models](/docs/concepts/embedding_models) and [VectorStore](/docs/concepts/vectorstores) that do not implement the [Runnable Interface](/docs/concepts/runnables) usually still follow the same rule and include the asynchronous version of method in the same class with an "a" prefix.")
    ...
    """
    logger.info("## Delegation to sync methods")
