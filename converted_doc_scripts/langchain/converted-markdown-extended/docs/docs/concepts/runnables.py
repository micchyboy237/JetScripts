...
Runnables expose an asynchronous API, allowing them to be called using the `await` syntax in Python. Asynchronous methods can be identified by the "a" prefix (e.g., `ainvoke`, `abatch`, `stream`, `abatch_as_completed`).
...
"""
logger.info("# Runnable interface")
...
"""
logger.info("### Propagation of RunnableConfig")
...
"""
logger.info("### Setting custom run name, tags, and metadata")
...
"""
logger.info("### Setting recursion limit")
...
"""
logger.info("## Creating a runnable from a function {#custom-runnables}")
