...
Please see this post from [Ollama](https://help.ollama.com/en/articles/4936856-what-are-tokens-and-how-to-count-them) for more details on how tokens are counted and how they correspond to text.

According to the Ollama post, the approximate token counts for English text are as follows:
