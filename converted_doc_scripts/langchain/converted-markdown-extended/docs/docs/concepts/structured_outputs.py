...
"""
logger.info("When combining structured output with additional tools, bind tools **first**, then apply structured output:")
...
"""
logger.info("As a second example, [Pydantic](https://docs.pydantic.dev/latest/) is particularly useful for defining structured output schemas because it offers type hints and validation.")
...
"""
logger.info("## Returning structured output")
...
"""
logger.info("The arguments of the tool call are already extracted as a dictionary.")
...
Here is an example of how to use JSON mode with Ollama:
"""
logger.info("### JSON mode")

model = ChatOllama(model="llama3.2").with_structured_output(method="json_mode")
...
"""
logger.info("## Structured output method")
...
:::
"""
logger.info("For more details on usage, see our [how-to guide](/docs/how_to/structured_output/#the-with_structured_output-method).")
