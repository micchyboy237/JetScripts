...
Providers support different approaches for this, including [JSON mode or tool calling](https://platform.ollama.com/docs/guides/structured-outputs), with different APIs.
...
"""
logger.info("Similarly, getting models to produce [structured outputs](/docs/concepts/structured_outputs/) is an extremely common use case.")
...
"""
logger.info("### Example: retrievers")
