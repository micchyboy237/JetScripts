...
"""
logger.info("#### Usage with chat models")
...
for event in chain.stream_events({"topic": "parrot"}):
    kind = event["event"]
    if kind == "on_chat_model_stream":
        logger.debug(event, end="|", flush=True)
...
Example:
"""
logger.info("## Writing custom data to the stream")
