...
"""
logger.info("### JSON Lines file")

file_path = './example_data/facebook_chat_messages.jsonl'
plogger.debug(Path(file_path).read_text())
...
"""
logger.info("Another option is to set `jq_schema='.'` and provide `content_key`:")
...
jq_schema   -> ".[]"
"""
logger.info("## Common JSON structures with jq schema")
