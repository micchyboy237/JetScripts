...
| create_ollama_fn_chain          | create_ollama_fn_runnable         | Use LCEL under the hood                        |
...
| OllamaFunctionsAgent            | create_ollama_functions_agent     | Use LCEL builder over a class                  |
| OllamaMultiFunctionsAgent       | create_ollama_tools_agent         | Use LCEL builder over a class                  |
