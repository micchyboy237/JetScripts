...
"""
logger.info("### Viewing documentation locally")
...
"""
logger.info("This will start a development server where you can view the documentation in your browser. The exact url will be shown to you during the start process. The server will automatically reload when you make changes to the documentation files under the `build/` directory (e.g. for temporary tests - changes you wish to persist should be put under `docs/docs/`).")
...
"""
logger.info("The API Reference documentation is built as static HTML files and will be automatically opened directly in your browser.")
...
"""
logger.info("The `make api_docs_build` command takes a long time. If you're making cosmetic changes to the API docs and want to see how they look, use:")
...
"""
logger.info("which will just build a small subset of the API reference (the `text-splitters` package).")
...
"""
logger.info("To clean up the documentation build artifacts, you can run:")
...
"""
logger.info("If you have formatting-related errors, you can fix them automatically with:")
...
"""
logger.info("## ⌨️ In-code documentation")
...
"""
logger.info("Then you can run the following commands to lint and format the in-code documentation:")
...
"""
logger.info("## Verify documentation changes")
