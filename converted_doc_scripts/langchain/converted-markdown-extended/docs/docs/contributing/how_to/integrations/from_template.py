...
"""
logger.info("# How to publish an integration package from a template")
...
"""
logger.info("## Set up a new package")
...
"""
logger.info("Let's say you want to create a new partner package working for a company called Parrot Link AI.")
...
"""
logger.info("## Implement your package")
...
"""
logger.info("If you need separate dependencies for type checking, you can add them to the `typing` group with:")
...
"""
logger.info("## Write Unit and Integration Tests")
...
"""
logger.info("After our change, it would look like this:")
