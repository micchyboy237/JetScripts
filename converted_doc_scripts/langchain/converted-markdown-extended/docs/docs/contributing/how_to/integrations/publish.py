...
"""
logger.info("# Publishing your package")
...
"""
logger.info("Next, build your package:")
...
"""
logger.info("Finally, publish your package to PyPi:")
...
"""
logger.info("## Adding documentation to the LangChain Monorepo")
...
"""
logger.info("### Bootstrap your documentation pages with the langchain-cli (recommended)")
...
"""
logger.info("To see the available commands to bootstrap your documentation pages, run:")
...
"""
logger.info("Let's bootstrap a provider page from the root of the monorepo:")
...
"""
logger.info("And a chat model component page:")
...
"""
logger.info("And a vector store component page:")
...
"""
logger.info("### Manually create your documentation pages (if you prefer)")
...
"""
logger.info("### Submit a PR with your changes")
