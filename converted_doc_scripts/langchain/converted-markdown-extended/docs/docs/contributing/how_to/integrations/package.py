...
"""
logger.info("# How to implement an integration package")
...
"""
logger.info("Next, come up with a name for your package. For this guide, we'll use `langchain-parrot-link`.")
...
"""
logger.info("Next, let's add any dependencies we need")
...
"""
logger.info("We can also add some `typing` or `test` dependencies in a separate poetry dependency group.")
...
"""
logger.info("You now have a new Python package with a template for LangChain components! This")
...
"""
logger.info("Add main dependencies using Poetry, which will add them to your `pyproject.toml` file:")
...
"""
logger.info("We will also add some `test` dependencies in a separate poetry dependency group. If")
...
as your integration package:
"""
logger.info("And finally, have poetry set up a virtual environment with your dependencies, as well")
...
"""
logger.info("### Writing your integration")
...
You can start from the following template or langchain-cli command:
"""
logger.info("### Push your package to a public Github repository")
