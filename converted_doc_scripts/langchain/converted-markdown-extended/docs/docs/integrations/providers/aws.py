...
from langchain_community.callbacks.bedrock_anthropic_callback import BedrockOllamaTokenUsageCallbackHandler
...
"""
logger.info("And there are also some community integrations available in the `langchain_community` package with the `boto3` optional dependency.")
...
"""
logger.info("See a [usage example](/docs/integrations/vectorstores/opensearch#using-aos-amazon-opensearch-service).")
...
"""
logger.info("### Amazon DocumentDB Vector Search")
...
"""
logger.info("#### Deploy DocumentDB on AWS")
...
"""
logger.info("See a [usage example](/docs/integrations/retrievers/amazon_kendra_retriever).")
...
We need to install the `langchain-aws` library.
"""
logger.info("### Amazon Bedrock (Knowledge Bases)")
...
"""
logger.info("See a [usage example](/docs/integrations/retrievers/bedrock).")
...
"""
logger.info("See a [usage example](/docs/integrations/memory/aws_dynamodb).")
...
"""
logger.info("### Amazon Neptune with Cypher")
...
"""
logger.info("See a [usage example](/docs/integrations/callbacks/sagemaker_tracking).")
...
"""
logger.info("See a [usage example](https://python.langchain.com/v0.1/docs/guides/productionization/safety/amazon_comprehend_chain/).")
