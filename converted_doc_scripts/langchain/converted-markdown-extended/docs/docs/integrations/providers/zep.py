...
"""
logger.info("See a [Perpetual Memory Example here](/docs/integrations/memory/zep_cloud_chat_message_history).")
...
"""
logger.info("See a [usage example](/docs/integrations/vectorstores/zep_cloud).")
