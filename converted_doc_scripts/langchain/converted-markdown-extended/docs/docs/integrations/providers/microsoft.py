...
1. [Azure Ollama](https://learn.microsoft.com/en-us/azure/ai-services/ollama/) - Provides access to Ollama's powerful models like o3, 4.1, and other models through Microsoft Azure's secure enterprise platform.
2. [Azure AI](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models) - Offers access to a variety of models from different providers including Ollama, DeepSeek, Cohere, Phi and Mistral through a unified API.
...
>[Azure Ollama](https://learn.microsoft.com/en-us/azure/cognitive-services/ollama/) is an `Azure` service with powerful language models from `Ollama` including the `GPT-3`, `Codex` and `Embeddings model` series for content generation, summarization, semantic search, and natural language to code translation.
"""
...
"""
Set the environment variables to get access to the `Azure Ollama` service.
"""
logger.info("Set the environment variables to get access to the `Azure Ollama` service.")


os.environ["AZURE_OPENAI_ENDPOINT"] = "https://<your-endpoint.ollama.azure.com/"
# os.environ["AZURE_OPENAI_API_KEY"] = "your AzureOllama key"

"""
See a [usage example](/docs/integrations/chat/azure_chat_ollama)
"""
logger.info("See a [usage example](/docs/integrations/chat/azure_chat_ollama)")


"""
### Azure AI

>[Azure AI Foundry](https://learn.microsoft.com/en-us/azure/developer/python/get-started) provides access to a wide range of models from various providers including Azure Ollama, DeepSeek R1, Cohere, Phi and Mistral through the `AzureAIChatCompletionsModel` class.
"""
...
"""
logger.info("### Azure ML Chat Online Endpoint")


"""
### Azure Ollama

See a [usage example](/docs/integrations/llms/azure_ollama).
"""
...
See a [usage example](/docs/integrations/text_embedding/azureollama)
"""
...
"""
logger.info("See a [usage example](/docs/integrations/document_loaders/azure_ai_data).")
...
"""
logger.info("### Azure AI Document Intelligence")
...
"""
logger.info("See a [usage example](/docs/integrations/document_loaders/azure_document_intelligence).")
...
"""
logger.info("See a [usage example for the Azure Blob Storage](/docs/integrations/document_loaders/azure_blob_storage_container).")


"""
See a [usage example for the Azure Files](/docs/integrations/document_loaders/azure_blob_storage_file).
"""
logger.info("See a [usage example for the Azure Files](/docs/integrations/document_loaders/azure_blob_storage_file).")
...
First, you need to install a python package.
"""
logger.info("### Microsoft OneDrive")
...
"""
logger.info("See a [usage example](/docs/integrations/document_loaders/microsoft_onedrive).")
...
First, you need to install a python package.
"""
logger.info("### Microsoft OneDrive File")
...
"""
logger.info("### Microsoft SharePoint")
...
"""
logger.info("See a [usage example](/docs/integrations/document_loaders/microsoft_onenote).")
...
"""
logger.info("See a [usage example](/docs/integrations/document_loaders/url/#playwright-url-loader).")
...
"""
logger.info("##### Deploy Azure Cosmos DB on Microsoft Azure")
...
"""
logger.info("#### Azure Cosmos DB NoSQL")
...
"""
logger.info("### Azure Database for PostgreSQL")
...
"""
logger.info("##### Deploy Azure SQL DB on Microsoft Azure")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/azure_dynamic_sessions).")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/azure_ai_services).")
...
We need to install several python packages.
"""
logger.info("#### Azure AI Services individual tools")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/azure_cognitive_services).")
...
"""
logger.info("### Microsoft Office 365 email and calendar")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/office365).")
...
"""
logger.info("#### Office 365 individual tools")
...
"""
logger.info("### Microsoft Azure PowerBI")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/powerbi).")
...
"""
logger.info("#### PowerBI individual tools")
...
"""
logger.info("See a [usage example](/docs/integrations/tools/playwright).")
...
"""
logger.info("#### PlayWright Browser individual tools")
...
"""
logger.info("See a [usage example](/docs/integrations/graphs/azure_cosmosdb_gremlin).")
...
pip install langchain-experimental ollama presidio-analyzer presidio-anonymizer spacy Faker
...
"""
logger.info("See [usage examples](https://python.langchain.com/v0.1/docs/guides/productionization/safety/presidio_data_anonymization).")
