...
async def main():
    ...
    """
    logger.info("# LangChain Decorators ✨")
    ...
    GlobalSettings.define_settings(
        default_llm=ChatOllama(model="llama3.2"), this is default... can change it here globally
        default_streaming_llm=ChatOllama(model="llama3.2"), this is default... can change it here for all ... will be used for streaming
    )
    
    """
    2. Using predefined **prompt types**
    """
    logger.info("2. Using predefined **prompt types**")
    
    
    PromptTypes.AGENT_REASONING.llm = ChatOllama(model="llama3.2")
    
    class MyCustomPromptTypes(PromptTypes):
        GPT4=PromptTypeSettings(llm=ChatOllama(model="llama3.2"))
    ...
    """
    logger.info("3.  Define the settings **directly in the decorator**")
    ...
    """
    logger.info("## Passing a memory and/or callbacks:")
    ...
    """
    logger.info("# Simplified streaming")
    ...
    with StreamingContext(stream_to_stdout=True, callback=capture_stream_func):
        ...
        logger.debug("Stream finished ... we can distinguish tokens thanks to alternating colors")
    ...
    """
    logger.info("# Prompt declarations")
    ...
    """
    logger.info("## Chat messages prompt")
    ...
    def simulate_conversation(human_input:str, agent_role:str="a pirate"):
        ...
        def hello():
            logger.debug("Argh... hello you pesky pirate")
        \```
        ```
    ...
    """
    logger.info("## More complex structures")
    ...
    logger.debug("Company name: ",company.name)
    logger.debug("company headline: ",company.headline)
    logger.debug("company employees: ",company.employees)
    
    """
    # Binding the prompt to an object
    """
    logger.info("# Binding the prompt to an object")
    ...
    logger.debug(personality.introduce_your_self(personality))
