...
"""
logger.info("When searching, you can also utilize the `filter` parameter which will allow you to filter by metadata:")
...
"""
logger.info("### Getting information about the store")
...
"""
logger.info("To use with your LLMs:")
