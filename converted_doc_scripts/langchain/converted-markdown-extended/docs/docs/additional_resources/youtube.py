...
- [Using `ChatGPT` with YOUR OWN Data. This is magical. (LangChain `Ollama API`)](https://youtu.be/9AXP7tCI9PI)
...
- [Development with Large Language Models Tutorial – `Ollama`, Langchain, Agents, `Chroma`](https://youtu.be/xZDB1naRUlk?si=v8J1q6oFHRyTkf7Y)
...
- [LLM Project | End to End LLM Project Using Langchain, `Ollama` in Finance Domain](https://youtu.be/MoqgmWV1fm8?si=oVl-5kJVgd3a07Y_)
...
- [LangChain GEN AI Tutorial – 6 End-to-End Projects using Ollama, Google `Gemini Pro`, `LLAMA2`](https://youtu.be/x0AnCE9SE4A?si=_92gJYm7kb-V2bi0)
...
- [Learn `LangChain.js` - Build LLM apps with JavaScript and `Ollama`](https://youtu.be/HSZ_uaif57o?si=Icj-RAhwMT-vHaYA)
...
- [Build a Custom Chatbot with `Ollama`: `GPT-Index` & LangChain | Step-by-Step Tutorial](https://youtu.be/FIDv6nc4CgU?si=gR1u3DUG9lvzBIKK)
- [Search Your `PDF` App using Langchain, `ChromaDB`, and Open Source LLM: No Ollama API (Runs on CPU)](https://youtu.be/rIV1EseKwU4?si=UxZEoXSiPai8fXgl)
- [Building a `RAG` application from scratch using Python, LangChain, and the `Ollama API`](https://youtu.be/BrsocJb-fAo?si=hvkh9iTGzJ-LnsX-)
