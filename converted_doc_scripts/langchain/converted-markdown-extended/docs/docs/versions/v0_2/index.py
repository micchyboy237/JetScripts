...
1. Install the 0.2.x versions of langchain-core, langchain and upgrade to recent versions of other packages that you may be using. (e.g. langgraph, langchain-community, langchain-ollama, etc.)
...
| langchain-community | jet.adapters.langchain.chat_ollama         | from langchain_community.chat_models import ChatOllama             | from jet.adapters.langchain.chat_ollama import ChatOllama                             |
...
For example, say your code still uses `from langchain.chat_models import ChatOllama`:
