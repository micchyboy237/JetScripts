...
"""
logger.info("# Migrating to astream_events(..., version="v2")")
...
"""
logger.info("As part of a chain the output was:")
...
Before:
"""
logger.info("### output for `on_retriever_end`")
...
"""
logger.info("### Removed `on_retriever_stream`")
