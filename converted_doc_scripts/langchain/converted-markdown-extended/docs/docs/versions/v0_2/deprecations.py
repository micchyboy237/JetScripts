...
- `langchain.chains.ollama_functions.get_openapi_chain`
...
Before 0.2.0:
"""
logger.info("# Deprecations and Breaking Changes")
...
logger.debug(my_tool.description)
...
#### convert_pydantic_to_ollama_function
...
Alternative: langchain_core.utils.function_calling.convert_to_ollama_function()


#### convert_pydantic_to_ollama_tool
...
Alternative: langchain_core.utils.function_calling.convert_to_ollama_tool()


#### convert_python_function_to_ollama_function
...
#### format_tool_to_ollama_function
...
In module: `agents.ollama_functions_agent.base`
Deprecated: 0.1.0
Removal: 0.3.0


Alternative: create_ollama_functions_agent
...
#### OllamaMultiFunctionsAgent


In module: `agents.ollama_functions_multi_agent.base`
Deprecated: 0.1.0
Removal: 0.3.0


Alternative: create_ollama_tools_agent
...
Alternative: langchain_cohere.CrossEncoderRerank
...
In module: `chains.ollama_tools.extraction`
Deprecated: 0.1.14
Removal: 0.3.0
...
#### create_ollama_fn_chain


In module: `chains.ollama_functions.base`
Deprecated: 0.1.1
Removal: 0.3.0


Alternative: create_ollama_fn_runnable
...
Alternative: ChatOllama.with_structured_output


#### create_extraction_chain


In module: `chains.ollama_functions.extraction`
Deprecated: 0.1.14
Removal: 0.3.0
...
Alternative: [with_structured_output](/docs/how_to/structured_output/#the-with_structured_output-method) method on chat models that support tool calling.
"""
logger.info("## Code that moved to another package")
