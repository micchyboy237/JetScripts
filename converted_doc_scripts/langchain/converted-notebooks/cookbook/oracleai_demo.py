...
"""
logger.info("### Load the ONNX Model")
...
"""
logger.info("The following sample code shows how to generate a summary:")
...
"""
logger.info("The following sample code shows how to generate embeddings:")
...
"""
logger.info("Next, let's combine all document processing stages together. Here is the sample code:")
...
logger.debug(vectorstore.max_marginal_relevance_search(query, 1, fetch_k=20, lambda_mult=0.5))
