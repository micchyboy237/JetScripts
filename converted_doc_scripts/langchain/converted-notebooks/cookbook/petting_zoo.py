...
"""
logger.info("# Multi-Agent Simulated Environment: Petting Zoo")
...
agents = {
    name: PettingZooAgent(name=name, model=ChatOllama(model="llama3.2"), env=env)
...
agents = {
    name: ActionMaskAgent(name=name, model=ChatOllama(model="llama3.2"), env=env)
    for name in env.possible_agents
}
main(agents, env)
...
"""
logger.info("## Texas Hold'em No Limit")
