...
In this notebook we will showcase how you can implement Ollama's [Contextual Retrieval](https://www.anthropic.com/news/contextual-retrieval) using LangChain. Contextual Retrieval addresses the conundrum of traditional RAG approaches by prepending chunk-specific explanatory context to each chunk before embedding.
...
# !pip install -q langchain langchain-ollama langchain-community faiss-cpu rank_bm25 langchain-cohere
...
llm = AzureChatOllama(
    ...
    ollama_api_version="2023-08-01-preview",
    temperature=0.0,
)
...
reranker = CrossEncoderRerank(top_n=3, model="rerank-english-v2.0")
