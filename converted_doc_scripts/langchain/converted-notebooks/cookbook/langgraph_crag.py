...
# ! pip install langchain-chroma langchain_community tiktoken langchain-ollama langchainhub langchain langgraph tavily-python
...
def decide_to_generate(state):
    ...
    if search == "Yes":
        logger.debug("---DECISION: TRANSFORM QUERY and RUN WEB SEARCH---")
