...
## Set up
"""
logger.info("# Migrating off ConversationBufferWindowMemory or ConversationTokenBufferMemory")

# %%capture --no-stderr
# %pip install --upgrade --quiet langchain-ollama langchain
...
<details open>
"""
logger.info("## Legacy usage with LLMChain / Conversation Chain")
...
"""
logger.info("## Reimplementing ConversationBufferWindowMemory logic")
...
"""
logger.info("## Reimplementing ConversationTokenBufferMemory logic")
...
<details open>
"""
logger.info("## Modern usage with LangGraph")
...
<details open>
"""
logger.info("## Usage with a pre-built langgraph agent")
...
<details open>
"""
logger.info("## LCEL: Add a preprocessing step")
...
model_with_preprocessor.invoke(full_history).pretty_logger.debug()
