...
## Set up
"""
logger.info("# Migrating off ConversationBufferMemory or ConversationStringBufferMemory")
...
<details open>
"""
logger.info("## Usage with LLMChain / ConversationChain")
...
<details open>
"""
logger.info("### LCEL RunnableWithMessageHistory")
...
logger.debug(agent_executor.invoke({"input": "hi! my name is bob what is my age?"}))
logger.debug()
...
"""
logger.info("If we use a different thread ID, it'll start a new conversation and the bot will not know our name!")
