...
## Set up
"""
logger.info("# How to use BaseChatMessageHistory with LangGraph")
...
"""
logger.info("## Use with LangGraph")
...
:::
"""
logger.info("This also supports streaming LLM content token by token if using langgraph >= 0.2.28.")
...
```
"""
logger.info("## Using With RunnableWithMessageHistory")
