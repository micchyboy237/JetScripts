...
Now let's look at them side-by-side. Note that for this guide we will `langchain-ollama >= 0.1.20`
"""
logger.info("# Migrating from MultiPromptChain")
...
async def route_query(state: State, config: RunnableConfig):
    ...
    logger.success(format_json(destination))
