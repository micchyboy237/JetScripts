...
"""
logger.info("# Migrating from RefineDocumentsChain")
...
"""
logger.info("We can step through the execution as follows, printing out the summary as it is refined:")
...
"""
logger.info("In the [LangSmith trace](https://smith.langchain.com/public/d6656f49-4fa1-44b9-b6d3-10af921037fa/r) we again recover three LLM calls, performing the same functions as before.")
