...
"""
logger.info("Initialize the `WatsonxEmbeddings` class with previously set parameters.")
...
"""
logger.info("For certain requirements, there is an option to pass the IBM's [`APIClient`](https://ibm.github.io/watsonx-ai-python-sdk/base.html#apiclient) object into the `WatsonxEmbeddings` class.")
