...
file_path = "https://assets.ctfassets.net/f1df9zr7wr1a/soP1fjvG1Wu66HJhu3FBS/034d6ca48edb119ae77dec5ce01a8612/Ollama_Sacra_Teardown.pdf"

# os.environ["OPENAI_API_KEY"] = (
    "zK3BAhQUmbwZNoHoOcscBwQdwi3oc3hzwJmbgdZ"  ## your-api-key
)

loader = ZeroxPDFLoader(file_path=file_path, model="azure/llama3.2")
...
Some examples of valid values are: 
  ...
  - `model = "azure/llama3.2"`
  - `model = "gemini/llama3.2"`
