...
"""
logger.info("When you pass a `folder_id` by default all files of type document, sheet and pdf are loaded. You can modify this behaviour by passing a `file_types` argument")
...
"""
logger.info("## Passing in Optional File Loaders")
...
"""
logger.info("You can also process a folder with a mix of files and Google Docs/Sheets using the following pattern:")
...
for doc in loader.load():
    logger.debug("---")
    logger.debug(doc.page_content.strip()[:60] + "...")
...
"""
logger.info("### Loading auth Identities")
...
"""
logger.info("You can pass load_auth=True, to add Google Drive document access identities to metadata.")
...
"""
logger.info("### Loading extended metadata")
...
"""
logger.info("You can pass load_extended_matadata=True, to add Google Drive document extended details to metadata.")
...
"""
logger.info("### Customize the search pattern")
...
"""
logger.info("You can customize your pattern.")
...
"""
logger.info("#### Modes for GSlide and GSheet")
...
"""
logger.info("The parameter `gsheet_mode` accepts different values:")
