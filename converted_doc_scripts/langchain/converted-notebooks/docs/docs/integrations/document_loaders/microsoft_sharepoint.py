...
def _get_default_parser() -> BaseBlobParser:
    """
logger.info("# Microsoft SharePoint")Get default mime-type based parser."""
...
handlers = {
    ...
    "audio/mpeg": OllamaWhisperParser()
}
...
```
"""
logger.info("# using file extensions:")
