...
"""
logger.info("The default output contains one LangChain document with markdown format content:")
...
"""
logger.info("The output will be each page stored as a separate document in the list:")

for document in documents:
    logger.debug(f"Page Content: {document.page_content}")
...
"""
logger.info("The output contains the LangChain document recognized with high resolution add-on capability:")
