...
pip install langchain-ollama==0.2.4
```
...
"""
logger.info("## Question Answering against the StarWars dataset")
...
"""
logger.info("Let's ask a simple one.")
...
"""
logger.info("And a bit more complicated one.")
...
"""
logger.info("We can also ask more complicated questions like")
...
- `qa_prompt`
  ...
  ````python
    GRAPHDB_QA_TEMPLATE = """
logger.info("### "Answering" prompt")Task: Generate a natural language response from the results of a SPARQL query.
...
"""
logger.info("GRAPHDB_QA_PROMPT = PromptTemplate(")
