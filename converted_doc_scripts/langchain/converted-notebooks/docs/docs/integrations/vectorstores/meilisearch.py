...
"""
logger.info("### Adding documents and embeddings")
...
"""
logger.info("## Add documents by creating a Meilisearch Vectorstore")


client = meilisearch.Client(url="http://127.0.0.1:7700")
