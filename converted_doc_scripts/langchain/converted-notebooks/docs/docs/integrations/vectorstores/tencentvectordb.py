...
"""
logger.info("load the documents, split them into chunks.")
...
"""
logger.info("we support two ways to embed the documents:")
...
"""
logger.info("now we can create a TencentVectorDB instance, you must provide at least one of the `embeddings` or `t_vdb_embedding` parameters. if both are provided, the `embeddings` parameter will be used:")
...
"""
logger.info("## Metadata and filtering")
