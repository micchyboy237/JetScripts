...
"""
logger.info("And we can start asking queries")
...
"""
logger.info("## Filtering based on file metadata")
...
"""
logger.info("## Getting information on indexed files")
