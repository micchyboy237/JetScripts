...
"""
logger.info("# Intel Weight-Only Quantization")
...
"""
logger.info("### Batch CPU Inference")
...
"""
logger.info("### Data Types Supported by Intel-extension-for-transformers")
