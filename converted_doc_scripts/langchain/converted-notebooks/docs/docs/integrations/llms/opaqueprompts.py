...
Applying OpaquePrompts to your application could be as simple as wrapping your LLM using the OpaquePrompts class by replace `llm=Ollama()` with `llm=OpaquePrompts(base_llm=Ollama())`.
"""
logger.info("# Use OpaquePrompts LLM Wrapper")
...
chain = LLMChain(
    ...
    llm=OpaquePrompts(base_llm=Ollama()),
...
"""
logger.info("# Context from user input")
