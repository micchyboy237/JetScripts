...
"""
logger.info("# CassandraByteStore")
...
"""
logger.info("Then you can create your store! You'll also need to provide the name of an existing keyspace of the Cassandra instance:")
