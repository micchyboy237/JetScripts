...
"""
logger.info("## Setting up the API credentials")
...
"""
logger.info("The run method will return the first result snippet from one of the following elements: answer_box, knowledge_graph, featured_snippet, shopping, organic.")
...
"""
logger.info("## The Difference Between `run` and `results`")
...
"""
logger.info("## Customizing Location and Language")
...
"""
logger.info("## Customizing the Search Engine")
...
"""
logger.info("## Customizing the Search Type")
...
"""
logger.info("## Integration with Langchain Agents")
