...
"""
logger.info("# Writer Text Splitter")
...
"""
logger.info("It's also helpful (but not needed) to set up [LangSmith](https://smith.langchain.com/) for best-in-class observability. If you wish to do so, you can set the `LANGSMITH_TRACING` and `LANGSMITH_API_KEY` environment variables:")
...
"""
logger.info("You can print the length of the chunks to see how many chunks were created:")
...
logger.success(format_json(async_chunks))
async_chunks

"""
Print the length of the chunks to see how many chunks were created:
"""
logger.info("Print the length of the chunks to see how many chunks were created:")

logger.debug(len(async_chunks))
