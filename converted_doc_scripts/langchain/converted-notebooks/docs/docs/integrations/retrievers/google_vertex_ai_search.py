...
"""
logger.info("# Google Vertex AI Search")
...
"""
logger.info("### Configure access to Google Cloud and Vertex AI Search")
...
"""
logger.info("### Configure and use the Vertex AI Search retriever")
...
"""
logger.info("### Configure and use the retriever for **unstructured** data with extractive answers")
...
"""
logger.info("### Configure and use the retriever for **structured** data")
...
"""
logger.info("### Configure and use the retriever for **website** data with Advanced Website Indexing")
...
"""
logger.info("### Configure and use the retriever for **blended** data")
...
"""
logger.info("### Configure and use the retriever for multi-turn search")
