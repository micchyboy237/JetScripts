...
We can accomplish this using the [Doctran](https://github.com/psychic-api/doctran) library, which uses Ollama's function calling feature to "interrogate" documents.
...
"""
logger.info("# Doctran: interrogate documents")
...
transformed_document = qa_transformer.transform_documents(documents)
logger.debug(json.dumps(transformed_document[0].metadata, indent=2))
