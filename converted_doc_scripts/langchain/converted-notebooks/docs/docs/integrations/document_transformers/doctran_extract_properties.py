...
We can extract useful features of documents using the [Doctran](https://github.com/psychic-api/doctran) library, which uses Ollama's function calling feature to extract specific metadata.
...
"""
logger.info("# Doctran: extract properties")
...
logger.debug(json.dumps(extracted_document[0].metadata, indent=2))
