...
"""
logger.info("# How to add memory to chatbots")

# %pip install --upgrade --quiet langchain langchain-ollama langgraph
...
"""
logger.info("## Automatic history management")
...
"""
logger.info("We'll pass the latest input to the conversation here and let LangGraph keep track of the conversation history using the checkpointer:")
...
"""
logger.info("## Modifying chat history")
...
"""
logger.info("We can see the app remembers the preloaded name.")
...
"""
logger.info("Let's call this new app and check the response")
...
"""
logger.info("And now, let's update the model-calling function to distill previous interactions into a summary:")
...
"""
logger.info("Let's see if it remembers the name we gave it:")
...
"""
logger.info("Note that invoking the app again will keep accumulating the history until it reaches the specified number of messages (four in our case). At that point we will generate another summary generated from the initial summary plus new messages and so on.")
