...
/>
"""
logger.info("# How to create a dynamic (self-constructing) chain")
...
"""
logger.info("The key here is that `contextualize_if_needed` returns another Runnable and not an actual output. This returned Runnable is itself run when the full chain is executed.")
