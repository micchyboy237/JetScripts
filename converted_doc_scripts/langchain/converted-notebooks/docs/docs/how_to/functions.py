...
async def main():
    ...
    """
    logger.info("# How to run custom functions")
    ...
    """
    logger.info("## The convenience `@chain` decorator")
    ...
    def custom_chain(text):
        ...
        output1 = ChatOllama(model="llama3.2").invoke(prompt_val1)
        parsed_output1 = StrOutputParser().invoke(output1)
        chain2 = prompt2 | ChatOllama(model="llama3.2") | StrOutputParser()
    ...
    If you are using a tracing with [LangSmith](https://docs.smith.langchain.com/), you should see a `custom_chain` trace in there, with the calls to Ollama nested underneath.
    ...
    """
    logger.info("## Automatic coercion in chains")
    ...
    """
    logger.info("## Passing run metadata")
    ...
    """
    logger.info("Next, we define a custom function that will aggregate the currently streamed output and yield it when the model generates the next comma in the list:")
    ...
    """
    logger.info("Invoking it gives a full array of values:")
