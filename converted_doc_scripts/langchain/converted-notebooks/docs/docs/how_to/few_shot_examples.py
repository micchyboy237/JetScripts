...
"""
logger.info("# How to use few shot examples")
...
"""
logger.info("## Creating the example set")
...
"""
logger.info("Let's test the formatting prompt with one of our examples:")

logger.debug(example_prompt.invoke(examples[0]).to_string())
...
"""
logger.info("### Pass the examples and formatter to `FewShotPromptTemplate`")
...
"""
logger.info("## Using an example selector")
...
logger.debug(f"Examples most similar to the input: {question}")
...
"""
logger.info("Now, let's create a `FewShotPromptTemplate` object. This object takes in the example selector and the formatter prompt for the few-shot examples.")
