...
"""
logger.info("# How to use few-shot prompting with tool calling")
...
"""
logger.info("Let's run our model where we can notice that even with some special instructions our model can get tripped up by order of operations.")
...
"""
logger.info("And we get the correct output this time.")
