...
agent_a2 = AssistantAgent("A", model_client=client,
...
agent_c1 = AssistantAgent("C1", model_client=client,
                          system_message="Handle task type 1. Say 'C1_COMPLETE' when done.")
agent_c2 = AssistantAgent("C2", model_client=client,
...
agent_a3 = AssistantAgent("A", model_client=client,
...
agent_d3 = AssistantAgent("D", model_client=client,
