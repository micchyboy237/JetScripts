...
async def main():
    ...
    Azure AI Services Blog on [Prompt Engineering for Ollama's O1 and O3-mini Reasoning Models](https://techcommunity.microsoft.com/blog/azure-ai-services-blog/prompt-engineering-for-ollama%E2%80%99s-o1-and-o3-mini-reasoning-models/4374010)
    ```
    """
