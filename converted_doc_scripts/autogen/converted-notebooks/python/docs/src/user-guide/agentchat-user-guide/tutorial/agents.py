async def main():
    ...
    For {py:class}`~autogen_ext.models.ollama.OllamaChatCompletionClient` and {py:class}`~autogen_ext.models.ollama.AzureOllamaChatCompletionClient`,
    ...
    - {py:class}`~autogen_ext.agents.ollama.OllamaAssistantAgent`: An agent that is backed by an Ollama Assistant, with ability to use custom tools.
