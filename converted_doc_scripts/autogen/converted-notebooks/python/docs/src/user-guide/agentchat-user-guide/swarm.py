...
async def main():
    ...
    [Swarm](https://github.com/ollama/swarm).
    ...
    **the speaker agent is selected based on the most recent
    ...
    client. For {py:class}`~jet.adapters.autogen.ollama_client.OllamaChatCompletionClient`
    and {py:class}`~jet.adapters.autogen.ollama_client.AzureOpenAIChatCompletionClient`,
