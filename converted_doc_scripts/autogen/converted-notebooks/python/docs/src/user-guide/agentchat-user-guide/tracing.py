...
from opentelemetry.instrumentation.ollama import OpenAIInstrumentor
...
async def main():
    ...
    ```bash
    pip install opentelemetry-sdk opentelemetry-exporter-otlp-proto-grpc opentelemetry-instrumentation-ollama
    ```
