...
"""
logger.info("Or, install via `Package Manager`")
...
"""
logger.info("Or, add via `<PackageReference>`")
...
"""
logger.info("# Additional Packages")
...
"""
logger.info("To enable running a system with agents in different processes that allows for x-language communication between python and .NET agents, there are additional packages:")
