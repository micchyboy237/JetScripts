...
"""
logger.info("and once we have the tunnel created we can just start forwarding with the following command:")
...
"""
logger.info("## How do I deploy the azure bits?")
...
"""
logger.info("After we've logged in, we need to create a new environment provision the azure bits.")
...
"""
logger.info("After the provisioning is done, you can inspect the outputs with the following command")
...
"""
logger.info("### Load the WAF into Qdrant.")
