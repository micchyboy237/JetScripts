...
[![](https://img.shields.io/badge/Open%20on%20Github-grey?logo=github)](https://github.com/microsoft/autogen/blob/main/dotnet/samples/AutoGen.Ollama.Sample/Use_Json_Mode.cs)
...
[!code-csharp[](../../samples/AutoGen.Ollama.Sample/Use_Json_Mode.cs?name=create_agent)]

After enabling JSON mode, the `openAIClientAgent` will always respond in JSON format when it receives a message.

[!code-csharp[](../../samples/AutoGen.Ollama.Sample/Use_Json_Mode.cs?name=chat_with_agent)]
...
[!code-csharp[](../../samples/AutoGen.Ollama.Sample/Use_Json_Mode.cs?name=person_class)]
