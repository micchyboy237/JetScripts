...
[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/MLXCodeSnippet.cs?name=create_openai_chat_agent)]

@AutoGen.MLX.MLXChatAgent also supports streaming chat via @AutoGen.Core.IAgent.GenerateStreamingReplyAsync*.

[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/MLXCodeSnippet.cs?name=create_openai_chat_agent_streaming)]
"""
