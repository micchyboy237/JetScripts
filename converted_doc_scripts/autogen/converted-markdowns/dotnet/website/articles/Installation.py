...
"""
logger.info("### Consume nightly build")
...
"""
logger.info("To add the feed to your global nuget config. You can do this by running the following command in your terminal:")
...
"""
logger.info("Once you have added the feed, you can install the nightly-build package using the following command:")
