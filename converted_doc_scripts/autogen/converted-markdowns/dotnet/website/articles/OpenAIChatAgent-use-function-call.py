...
[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/OllamaCodeSnippet.cs?name=weather_function)]
...
[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/OllamaCodeSnippet.cs?name=openai_chat_agent_get_weather_function_call)]
...
[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/OllamaCodeSnippet.cs?name=create_function_call_middleware)]

Finally, you can chat with the @AutoGen.Ollama.OllamaChatAgent and invoke the `GetWeather` function.

[!code-csharp[](../../samples/AgentChat/Autogen.Basic.Sample/CodeSnippet/OllamaCodeSnippet.cs?name=chat_agent_send_function_call)]
"""
