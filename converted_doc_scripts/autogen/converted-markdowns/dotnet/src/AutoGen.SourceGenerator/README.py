...
"""
logger.info("### AutoGen.SourceGenerator")
...
"""
logger.info("Then, for the methods you want to generate function definition and function call wrapper, mark them with `Function` attribute:")
...
"""
logger.info("The source generator will generate the following code based on the method signature and documentation. It helps you save the effort of writing function definition and keep it up to date with the actual method signature.")
...
"""
logger.info("For more examples, please check out the following project")
