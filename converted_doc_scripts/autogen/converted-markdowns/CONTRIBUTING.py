...
"""
logger.info("## Docs when adding a new API")
...
"""
logger.info("See [here](https://pydata-sphinx-theme.readthedocs.io/en/stable/examples/kitchen-sink/admonitions.html#versionadded) for how they are rendered.")
