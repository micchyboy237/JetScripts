...
"""
logger.info("## Gallery - Sharing and Reusing Components")
...
"""
logger.info("To export team configurations, use the export button in Team Builder to generate a JSON file for Python application use.")
