...
"""
logger.info("# Topic and Subscription")
...
"""
logger.info("Similar to [agent ID](./agent-identity-and-lifecycle.md#agent-id),")
...
"""
logger.info("### Scenarios of Type-Based Subscription")
...
"""
logger.info("With the above type-based subscriptions, use the same topic source")
...
"""
logger.info("#### Single-Tenant, Multiple Topics")
...
"""
logger.info("#### Multi-Tenant Scenarios")
...
`"triage_agent"`:
"""
logger.info("Continuing the example above, if you want to have dedicated instances of agents")
...
"""
logger.info("When a message is published to the topic")
