...
"""
logger.info("To run this sample, you will need to install the following packages:")
...
"""
logger.info("By default, the game will use a random agent to play against the AI agent.")
