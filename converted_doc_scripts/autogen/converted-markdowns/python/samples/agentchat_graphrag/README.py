...
"""
logger.info("# Building an AI Assistant Application with AutoGen and GraphRAG")
...
"""
logger.info("Alternatively, you can update the `.env` file with the API Key that will be used by GraphRAG:")
...
"""
logger.info("## Running the Sample")
