...
"""
logger.info("#### A) Install from source manually")
...
"""
logger.info("## AutoGen Studio Lite")
...
"""
logger.info("### Programmatic Usage")
...
"""
logger.info("#### Local frontend development server")
