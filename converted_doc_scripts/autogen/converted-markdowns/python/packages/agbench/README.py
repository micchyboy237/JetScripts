...
"""
logger.info("Create a file called ENV.json with the following (required) contents (If you're using MagenticOne), if using Azure:")
...
"""
logger.info("You can also use the openai client by replacing the last two entries in the ENV file by:")
...
"""
logger.info("Now initialize the tasks.")
...
"""
logger.info("## Running AutoGenBench")
