...
"""
logger.info("id: red-teaming-vulnerabilities-intellectual-property")
...
"""
logger.info("Learn more how to red teaming LLM systems using the intellectual property vulnerability on [DeepTeam's docs.](https://trydeepteam.com/docs/red-teaming-vulnerabilities-intellectual-property)")
