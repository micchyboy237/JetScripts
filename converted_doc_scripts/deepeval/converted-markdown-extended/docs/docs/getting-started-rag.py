...
"""
logger.info("## Run Your First RAG Eval")
...
"""
logger.info("Instead of changing your code to return these data, we'll show a better way to run RAG evals in the next section.")
...
"""
logger.info("Define RAG metrics to evaluate your RAG pipeline, or define your own using [G-Eval](/docs/metrics-llm-evals).")
...
"""
logger.info("DeepEval offers a total of 5 RAG metrics, which are:")
...
"""
logger.info("This creates a test run, which is a "snapshot"/benchmark of your RAG pipeline at any point in time.")
...
"""
logger.info("## Evaluate Retriever")
...
"""
logger.info("Set the `CONFIDENT_TRACE_FLUSH=YES` in your CLI to prevent traces from being lost in case of an early program termination.")
...
"""
logger.info("Create a retriever focused metric. You'll then need to:")
...
"""
logger.info("Finally, use the `dataset` iterator to invoke your RAG system on a list of goldens.")
...
"""
logger.info("You can also evaluate your retriever if it is nested within a RAG pipeline:")
...
"""
logger.info("Create a generator focused metric. You'll then need to:")
...
"""
logger.info("You can also combine retriever and generator evals:")
...
"""
logger.info("## Multi-Turn RAG Evals")
...
"""
logger.info("Since your chatbot uses RAG, each turn from the assistant should also include the `retrieval_context` parameter.")
...
"""
logger.info("Run an evaluation on the test case using the `evaluate` function and the conversational RAG metric you've defined.")
