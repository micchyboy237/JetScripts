...
"""
logger.info("id: red-teaming-vulnerabilities-toxicity")
...
"""
logger.info("Learn more how to red teaming LLM systems using the toxicity vulnerability on [DeepTeam's docs.](https://trydeepteam.com/docs/red-teaming-vulnerabilities-toxicity)")
