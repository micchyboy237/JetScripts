...
- [Optional] `evaluation_model`: a string specifying which of Ollama's GPT models to use for scoring, **OR** [any custom LLM model](/docs/metrics-introduction#using-a-custom-llm) of type `DeepEvalBaseLLM`. Defaulted to `gpt-4.1`.
...
- `OXYGEN`
"""
logger.info("Below is the comprehensive list of available tasks:")
