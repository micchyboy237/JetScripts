...
"""
logger.info("id: red-teaming-vulnerabilities-graphic-content")
...
"""
logger.info("Learn more how to red teaming LLM systems using the graphic content vulnerability on [DeepTeam's docs.](https://trydeepteam.com/docs/red-teaming-vulnerabilities-graphic-content)")
