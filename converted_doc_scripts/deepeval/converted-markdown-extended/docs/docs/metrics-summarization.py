...
"""
logger.info("You can use the `SummarizationMetric` as follows for [end-to-end](/docs/evaluation-end-to-end-llm-evals) evaluation:")
...
logger.debug(metric.reason)
logger.debug(metric.score_breakdown)
...
:::
"""
logger.info("Since the summarization score is the minimum of the `alignment_score` and `coverage_score`, a 0 value for either one of these scores will result in a final summarization score of 0.")
