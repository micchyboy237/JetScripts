...
from ollama import Ollama, AsyncOpenAI
...
"""
logger.info("# id: guides-red-teaming")
...
"""
logger.info("### Testing your Target LLM")
...
"""
logger.info("## 2. Initializing the RedTeamer")
...
:::note
If you're using ollama models as your evaluator or synthesizer, simply provide a string representing the model name. Otherwise, you'll need to define a **custom model in DeepEval**. [Visit this guide](/guides/guides-using-custom-llms) to learn how.
:::
...
"""
logger.info("### Target LLM Parameters")
...
logger.debug("Red Teaming Results: ", results)
...
"""
logger.info("### Tips for Effective Red-Teaming Scans")

logger.debug("Vulnerability Scores Summary:")
logger.debug(red_teamer.vulnerability_scores)
...
"""
logger.info("### Detailed Vulnerability Breakdown")
...
logger.debug("Excessive Agency Detailed Breakdown:")
logger.debug(excessive_agency_issues)
...
:::
"""
logger.info("## 5. Iterating on Your Target LLM")
