...
"""
logger.info("# id: guides-using-synthesizer")
...
"""
logger.info("The `generate_goldens_from_docs` function follows several key steps to transform your documents into high-quality goldens:")
...
:::
"""
logger.info("### Best Practices for Chunking")
...
"""
logger.info("### Best Practices for Using Evolutions")
...
"""
logger.info("## Qualifying Synthetic Goldens")
