...
"""
logger.info("# id: guides-rag-triad")
...
"""
logger.info("Here, `input` is the user query, `actual_output` is the LLM generated response, and `retrieval_context` is a list of strings representing the retrieved text chunks. Then, define the RAG triad metrics:")
...
"""
logger.info("You can find how these metrics are implemented and calculated on their respective documentation pages:")
...
"""
logger.info("## Scaling RAG Evaluation")
