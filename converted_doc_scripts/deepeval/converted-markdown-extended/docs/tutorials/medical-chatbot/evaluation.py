...
:::tip
This example assumes each conversation is a list of messages following the Ollama-style format, where messages have a role ("user" or "assistant") and `content`. To learn what the `Turn` data model looks like, [click here.](/docs/evaluation-multiturn-test-cases#turns)
:::
...
"""
logger.info("In reality, you'll need at least **20 goldens** for a barely-big-enough dataset, as each golden produces a single test case.")
...
"""
logger.info("## Create Your Metrics")
...
"""
logger.info("## Run Your First Multi-Turn Eval")
...
"""
logger.info("You can also run `deepeval view` to see results on Confident AI:")
