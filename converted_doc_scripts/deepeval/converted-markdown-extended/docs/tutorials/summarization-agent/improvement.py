...
"""
logger.info("The dataset pulled contains goldens, which can be used to create test cases during run time and run evals. Here's how to create test cases using datasets:")
...
logger.debug(len(summary_test_cases))
logger.debug(len(action_item_test_cases))
...
"""
logger.info("By logging hyperparameters in the evaluate function, you can easily compare performance across runs in [Confident AI](https://www.confident-ai.com) and trace score changes back to specific hyperparameter adjustments. Learn more about [the evaluate function here](https://deepeval.com/docs/evaluation-introduction#evaluating-without-pytest).")
...
"""
logger.info("## Improving From Eval Results")
...
"""
logger.info("This setup allows you to change your model for these tasks anytime you want. You now have a robust summarization agent for generating summaries and action items.")
