...
"""
logger.info("## Why Continuous Evaluation")
...
:::
"""
logger.info("And that's it! You now have a **robust, production-ready summarization agent** with automated evaluation integrated into your development workflow.")
