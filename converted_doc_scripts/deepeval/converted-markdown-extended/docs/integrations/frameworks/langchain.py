...
"""
logger.info("Only [Task Completion](/docs/metrics-task-completion) is supported for the LangChain integration. To use other metrics, manually [set up tracing](/docs/evaluation-llm-tracing) instead.")
