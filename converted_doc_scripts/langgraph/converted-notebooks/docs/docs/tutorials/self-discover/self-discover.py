...
## Define the prompts
"""
logger.info("## Define the prompts")


select_prompt = hub.pull("hwchase17/self-discovery-select")
logger.debug("Self-Discovery Select Prompt:")
select_prompt.pretty_logger.debug()
logger.debug("Self-Discovery Select Response:")
adapt_prompt = hub.pull("hwchase17/self-discovery-adapt")
adapt_prompt.pretty_logger.debug()
structured_prompt = hub.pull("hwchase17/self-discovery-structure")
logger.debug("Self-Discovery Structured Prompt:")
structured_prompt.pretty_logger.debug()
reasoning_prompt = hub.pull("hwchase17/self-discovery-reasoning")
logger.debug("Self-Discovery Structured Response:")
reasoning_prompt.pretty_logger.debug()
