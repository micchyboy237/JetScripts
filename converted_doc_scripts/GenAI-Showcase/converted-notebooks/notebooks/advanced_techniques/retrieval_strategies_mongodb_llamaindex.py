...
<p>
- **llama-index-llms-ollama**: Python package to use Ollama models via their LlamaIndex integration 
<p>
...
# !pip install -qU pymongo llama-index llama-index-llms-ollama llama-index-vector-stores-mongodb datasets ollama
