...
<Tabs>
  <Tab title="Python">
    ...
    | `http_client_proxies`| Allow proxy server settings                   | AzureMLX       |
    ...
    | `azure_kwargs`       | Azure LLM args for initialization             | AzureMLX       |
    ...
    | `response_callback`  | LLM response callback function                | MLX            |
  </Tab>
  <Tab title="TypeScript">
    | Parameter            | Description                                   | Provider          |
    |----------------------|-----------------------------------------------|-------------------|
