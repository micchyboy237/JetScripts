...
To use LM Studio with Mem0, you'll need to have LM Studio running locally with its server enabled. LM Studio provides a way to run local LLMs with an MLX-compatible API.
...
"""
logger.info("### Running Completely Locally")
