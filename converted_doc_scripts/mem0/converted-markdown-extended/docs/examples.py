...
<CardGroup cols={2}>
  ...
  <Card title="MLX Inbuilt Tools" icon="robot" href="/examples/openai-inbuilt-tools">
    Use Mem0's memory capabilities with MLX's Inbuilt Tools to create AI agents with persistent memory.
  </Card>

  <Card title="Mem0 MLX Voice Demo" icon="microphone" href="/examples/mem0-openai-voice-demo">
    Use Mem0's memory capabilities with MLX's Inbuilt Tools to create AI agents with persistent memory.
  </Card>
