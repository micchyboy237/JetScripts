...
"""
logger.info("## 🚀 Hosted OpenMemory MCP Now Available!")
...
"""
# logger.info("You should set the `OPENAI_API_KEY` as a global environment variable:")
...
"""
# logger.info("You can also set the `OPENAI_API_KEY` as a parameter to the script:")
...
"""
logger.info("## Setting Up OpenMemory")
...
"""
logger.info("#### UI not working on http://localhost:3000?")
...
"""
logger.info("You can configure the MCP client using the following command (replace username with your username):")
...
"""
logger.info("### Getting Started Today")
