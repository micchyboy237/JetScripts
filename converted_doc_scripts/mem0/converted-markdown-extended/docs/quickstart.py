...
<CodeGroup>
"""
logger.info("## Mem0 Platform (Managed Solution)")
...
<CodeGroup>
"""
logger.info("### 3. Retrieve Memories")
...
<CodeGroup>
"""
logger.info("### 2. Add Memories <a name="2-add-memories-open-source"></a>")
...
result = memory.add(messages, { userId: "alice", metadata: { category: "preferences" } })
...
<CodeGroup>
"""
logger.info("### 3. Retrieve Memories <a name="3-retrieve-memories-open-source"></a>")
...
"""
logger.info("Learn more about Mem0 OSS Python SDK")
