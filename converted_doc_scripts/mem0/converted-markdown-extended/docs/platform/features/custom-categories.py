...
<CodeGroup>
"""
logger.info("## How to set custom categories?")
...
<CodeGroup>
"""
logger.info("This is how you will use these custom categories during the `add` API call:")
...
<CodeGroup>
"""
logger.info("You can also retrieve the current custom categories:")
...
<CodeGroup>
"""
logger.info("### 2. During the `add` API call")
...
<CodeGroup>
"""
logger.info("## Default Categories")
...
<CodeGroup>
"""
logger.info("You can check whether default categories are being used by calling `project.get()`. If `custom_categories` returns `None`, it means the default categories are being used.")
