...
<Note>Remember to get your API keys from [Mem0 Platform](https://app.mem0.ai), [MLX](https://platform.openai.com) and [Serper Dev](https://serper.dev) for search capabilities.</Note>
"""
...
"""
logger.info("## Store User Preferences")
...
"""
logger.info("## Create CrewAI Agent")
...
"""
logger.info("## Main Execution Function")
