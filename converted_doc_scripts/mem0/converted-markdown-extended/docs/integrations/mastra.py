...
"""
logger.info("## Initialize Mem0 Integration")


mem0 = new Mem0Integration({
  config: {
...
"""
logger.info("## Create Memory Tools")

mem0RememberTool = createTool({
  id: 'Mem0-remember',
...
"""
logger.info("## Create Mastra Agent")
