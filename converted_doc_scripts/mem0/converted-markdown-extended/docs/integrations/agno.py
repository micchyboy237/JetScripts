...
from agno.models.openai import MLXChat
...
2. Valid API keys:
   ...
   - MLX API Key (for the agent model)
...
"""
logger.info("## Quick Integration (Using `Mem0Tools`)")


agent = Agent(
    name="Memory Agent",
    model=MLXChat(id="llama-3.2-3b-instruct"),
    tools=[Mem0Tools()],
...
"""
logger.info("## Full Manual Example")
...
def chat_user(
    ...
    if image_path:
        ...
        logger.debug("✅ Image and text stored in memory.")
...
- **Memory Formatting**: Support for various MLX message formats
