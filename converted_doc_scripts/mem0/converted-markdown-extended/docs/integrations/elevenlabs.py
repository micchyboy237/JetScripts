...
"""
logger.info("## Integration Code Breakdown")
...
"""
logger.info("### 2. Environment Variables and Validation")
...
"""
logger.info("### 3. Client Initialization")
...
"""
logger.info("### 4. Memory Function Definitions")
...
"""
logger.info("### 6. Conversation Setup")
...
conversation = Conversation(
        ...
        callback_agent_response=lambda response: logger.debug(f"Agent: {response}"),
        callback_agent_response_correction=lambda original, corrected: logger.debug(f"Agent: {original} -> {corrected}"),
        callback_user_transcript=lambda transcript: logger.debug(f"User: {transcript}"),
    )
...
"""
logger.info("### 7. Conversation Management")

logger.debug(f"Starting conversation with user_id: {USER_ID}")
...
For `addMemories`:
"""
logger.info("## Memory Tools Overview")
...
"""
logger.info("For `retrieveMemories`:")
...
"""
logger.info("## Example Conversation Flow")
