...
**New Features:**
- **MLX Agents:** Added MLX agents SDK support
...
- **vLLM:** Fixed missing MLX import in vLLM module and call errors
...
**New Features:**
- **LLM:** Added support for MLX compatible LLM providers with baseUrl configuration
...
**New Features:**
- **LLM Integrations:** Added Azure MLX Embedding Model
- **Examples:**
...
- **Azure MLX:** Added patch to fix Azure MLX
...
- **Examples:**
  ...
  - Added agno example
  - Updated MLX Responses API examples
...
**Bug Fixes:**
- **MLX Environment Variables:** Fixed issues with MLX environment variables
...
**Bug Fixes:**
- **Azure MLX:** Fixed issues with Azure MLX
...
- **OSS SDK:** Added support for Azure MLX Embedder
...
- **OSS SDK:** - Updated Azure MLX to use new MLX SDK
</Update>
...
**New Features:**
- **Azure MLX:** Added support for Azure MLX
...
**New Features:**
- **Memory Management:** Implemented MLX Batch API for Memory Cleaning with fallback
...
"""
logger.info("title: "Product Updates"")
