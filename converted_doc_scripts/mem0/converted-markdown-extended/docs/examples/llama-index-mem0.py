...
"""
logger.info("Initialize the Mem0 client. You can find your API key [here](https://app.mem0.ai/dashboard/api-keys). Read about Mem0 [Open Source](https://docs.mem0.ai/open-source/overview).")
...
"""
logger.info("Create the tools. These tools will be used by the agent to perform actions.")
...
"""
logger.info("Initialize the agent with tools and memory.")
...
Input
"""
logger.info("### Using the agent WITHOUT memory")
...
Input
"""
logger.info("### Using the agent WITH memory")
