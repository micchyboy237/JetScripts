...
"""
logger.info("## Why Personalized Search")
...
"""
logger.info("2. Set up your API keys in a .env file:")
...
"""
logger.info("### 2. Simulating User History")
...
"""
logger.info("### 3. Retrieving User Context from Memory")
...
"""
logger.info("### 4. Creating the Personalized Search Agent")
...
"""
logger.info("### 5. Run a Personalized Search")
...
"""
logger.info("### 6. Store New Interactions")
...
if __name__ == "__main__":
    ...
    for q in queries:
        ...
        logger.debug(f"\nQuery: {q}")
        logger.debug(f"Personalized Response: {results['agent_response']}")
...
"""
logger.info("## How It Works in Practice")
