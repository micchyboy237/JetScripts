...
<CodeGroup>
"""
logger.info("title: 'Custom configurations'")
...
2. `llm` Section:
    ...
    - `config`:
        - `model` (String): The specific model being used, 'llama-3.2-3b-instruct'.
...
"""
logger.info("Alright, let's dive into what each key means in the yaml config above:")
