...
* Update Ollama API response by [@lucafirefox](https://github.com/lucafirefox) in [#213](https://github.com/MaartenGr/KeyBERT/pull/213)
...
* Fix support for ollama>=1

You can now use it as follows:
"""
logger.info("## **Version 0.8.5**")
...
* Use `KeyLLM` to leverage LLMs for extracting keywords
  ...
  * Multiple LLMs are integrated: Ollama, Cohere, LangChain, HF, and LiteLLM
"""
logger.info("## **Version 0.8.2**")
