...
"""
logger.info("# CountVectorizer Tips & Tricks")
...
"""
logger.info("We will use the above code throughout this tutorial as the base and built upon it with the CountVectorizer.")
...
"""
logger.info("Then, we pass that vocabulary to our CountVectorizer and extract our keywords:")
...
"""
logger.info("Then, simply pass the vectorizer to your KeyBERT instance:")
...
"""
logger.info("## **KeyphraseVectorizers**")
...
"""
logger.info("Then, let's see what the output looks like with the basic `CountVectorizer` using a larger n-gram value:")
...
"""
logger.info("Not bad but as we have seen before, this can definitely be improved. Now, let's use the `KeyphraseCountVectorizer` instead:")
...
"""
logger.info("A large improvement compared to the basic CountVectorizer! Now, as seen before it seems that there are still some repeated keyphrases that we want to remove. To do this,")
...
"""
logger.info("Although the above keyphrases seem accurate, we might want to only extract a noun from the documents in")
...
"""
logger.info("These seem much better as keywords now that we focus only on nouns in the document.")
