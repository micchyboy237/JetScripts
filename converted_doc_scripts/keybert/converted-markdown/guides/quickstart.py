...
"""
logger.info("You can set `keyphrase_ngram_range` to set the length of the resulting keywords/keyphrases:")
...
"""
logger.info("To extract keyphrases, simply set `keyphrase_ngram_range` to (1, 2) or higher depending on the number")
...
"""
logger.info("We can highlight the keywords in the document by simply setting `highlight`:")
...
"""
logger.info("The results with **low diversity**:")
...
"""
logger.info("## **Candidate Keywords/Keyphrases**")
...
"""
logger.info("You can then use these embeddings and pass them to `.extract_keywords` to speed up the tuning the model:")
...
"""
logger.info("There are several parameters in `.extract_embeddings` that define how the list of candidate keywords/keyphrases is generated:")
...
"""
logger.info("The following, however, will throw an error since we did not use the same values for `min_df` and `stop_words`:")
